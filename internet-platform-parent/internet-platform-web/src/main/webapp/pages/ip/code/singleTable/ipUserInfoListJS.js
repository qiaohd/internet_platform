define([ 'jquery', 'knockout','text!./ipUserInfoList.html','bootstrap', 'uui', 'director', 'tree', 'grid','dragJW','css!./ipUserInfoList.css'], function($, ko,template) {
		...
		viewModel. editPage = function(data){
		    ...
		    for(var i = 0; i <data.genTable.columnList.length; i++){
              if(data.genTable.columnList[i].isQuery == "Y"){
