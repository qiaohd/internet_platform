...
(function(){function a(a){return 10>a?"0"+a:a}function c(a){f.lastIndex=0;return f.test(a)?'"'+a.replace(f,function(a){var c=q[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function d(a,f){var e,q,C,z,l=g,A,n=f[a];n&&"object"===typeof n&&"function"===typeof n.toJSON&&(n=n.toJSON(a));"function"===typeof t&&(n=t.call(f,a,n));switch(typeof n){case "string":return c(n);case "number":return isFinite(n)?String(n):"null";case "boolean":case "null":return String(n);
case "object":if(!n)return"null";g+=k;A=[];if("[object Array]"===Object.prototype.toString.apply(n)){z=n.length;for(e=0;e<z;e+=1)A[e]=d(e,n)||"null";C=0===A.length?"[]":g?"[\n"+g+A.join(",\n"+g)+"\n"+l+"]":"["+A.join(",")+"]";g=l;return C}if(t&&"object"===typeof t)for(z=t.length,e=0;e<z;e+=1)"string"===typeof t[e]&&(q=t[e],(C=d(q,n))&&A.push(c(q)+(g?": ":":")+C));else for(q in n)Object.prototype.hasOwnProperty.call(n,q)&&(C=d(q,n))&&A.push(c(q)+(g?": ":":")+C);C=0===A.length?"{}":g?"{\n"+g+A.join(",\n"+
g)+"\n"+l+"}":"{"+A.join(",")+"}";g=l;return C}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var e,f,g,k,q,t;"function"!==typeof JSON.stringify&&(f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
q={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},JSON.stringify=function(a,c,f){var e;k=g="";if("number"===typeof f)for(e=0;e<f;e+=1)k+=" ";else"string"===typeof f&&(k=f);if((t=c)&&"function"!==typeof c&&("object"!==typeof c||"number"!==typeof c.length))throw Error("JSON.stringify");return d("",{"":a})});"function"!==typeof JSON.parse&&(e=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,JSON.parse=function(a,
c){function d(a,f){var e,g,k=a[f];if(k&&"object"===typeof k)for(e in k)Object.prototype.hasOwnProperty.call(k,e)&&(g=d(k,e),void 0!==g?k[e]=g:delete k[e]);return c.call(a,f,k)}var f;a=String(a);e.lastIndex=0;e.test(a)&&(a=a.replace(e,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return f=
...
e&&(a+=";path="+e);f&&(a+=";domain="+f);g&&(a+=";secure");document.cookie=a},"delete":function(a,c,d){get_cookie(a)&&(a+="=;expires=Fri, 02-Jan-1970 00:00:00 GMT",c&&(a+=";path="+c),d&&(a+=";domain="+d),document.cookie=a)}},array:{comparisonAsc:function(a){return function(c,d){return c[a]-d[a]}},comparisonDesc:function(a){return function(c,d){return d[a]-c[a]}}},isWhateType:function(a,c){return"Null"===c&&null===a||"Undefined"===c&&void 0===a||"Number"===c&&isFinite(a)||Object.prototype.toString.call(a).slice(8,
-1)===c},dom:{convertToArray:function(a){var c=null;try{c=Array.prototype.slice.call(a,0)}catch(d){for(var c=[],e=0,f=a.length;e<f;e++)c.push(a[e])}return c}}},YYIMRegularUtil={mobile:/^[1][358][0-9]{9}$/,phone:/((\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/};function XmlHttp(){}
...
JSJaCConnection.prototype.registerHandler=function(a,c,d,e){a=a.toLowerCase();var f={handler:arguments[arguments.length-1],ns:"*",type:"*"};2<arguments.length&&(f.ns=arguments[1]);3<arguments.length&&(f.type=arguments[2]);this._events[a]=this._events[a]?this._events[a].concat(f):[f];this._events[a]=this._events[a].sort(function(a,c){var d=0,f=0;"*"==a.type&&d++;"*"==a.ns&&d++;d++;"*"==c.type&&f++;"*"==c.ns&&f++;return d>f?1:d<f?-1:0});this.oDbg.log("registered handler for event '"+a+"'",2);return this};
...
function JSJaCHttpBindingConnection(a){this.base=JSJaCConnection;this.base(a);this._hold=JSJACHBC_MAX_HOLD;this._inactivity=0;this._last_requests={};this._pause=this._min_polling=this._last_rid=0;this._wait=a.wait||JSJACHBC_MAX_WAIT;(function(){function a(c,d){return this.slice(c,d)}function d(a,c){2>arguments.length&&(c=0);for(var d=0,f=a.length;d<f;++d,++c)this[c]=a[d]&255}function e(f){var e;if("number"===typeof f){e=Array(f);for(var q=0;q<f;++q)e[q]=0}else e=f.slice(0);e.subarray=a;e.buffer=e;
e.byteLength=e.length;e.set=d;"object"===typeof f&&f.buffer&&(e.buffer=f.buffer);return e}try{new Uint8Array(1);return}catch(f){}window.Uint8Array=e;window.Uint32Array=e;window.Int32Array=e})()}JSJaCHttpBindingConnection.prototype=new JSJaCConnection;
...
JSJaCJSON.toString=function(a){var c={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},d={array:function(a){var c=["["],g,k,q,t=a.length,v;for(q=0;q<t;q+=1)if(v=a[q],k=d[typeof v])try{v=k(v),"string"==typeof v&&(g&&(c[c.length]=","),c[c.length]=v,g=!0)}catch(s){}c[c.length]="]";return c.join("")},"boolean":function(a){return String(a)},"null":function(){return"null"},number:function(a){return isFinite(a)?String(a):"null"},object:function(a){if(a){if(a instanceof Array)return d.array(a);
var c=[],g,k,q,t;c.push("{");for(q in a)if(a.hasOwnProperty(q)&&(t=a[q],k=d[typeof t]))try{t=k(t),"string"==typeof t&&(g&&(c[c.length]=","),c.push(d.string(q),":",t),g=!0)}catch(v){}c[c.length]="}";return c.join("")}return"null"},string:function(a){/["\\\x00-\x1f]/.test(a)&&(a=a.replace(/([\x00-\x1f\\"])/g,function(a,d){var e=c[d];if(e)return e;e=d.charCodeAt();return"\\u00"+Math.floor(e/16).toString(16)+(e%16).toString(16)}));return'"'+a+'"'}};switch(typeof a){case "object":return d.object(a);case "array":return d.array(a)}};
...
JSJaCWebSocketConnection.prototype._buildAndSend=function(a){var c=null,d=null==a.content||"undefined"==typeof a.content,e=new Blob([JSON.stringify(a.content)],{type:"text/json"}),f=new FileReader,g=this;f.onload=function(f){f.target.readyState==FileReader.DONE&&(c=this.result,f=new Uint8Array(PACKET_HEADER_SIZE),f.set(g._numToBytes(a.sFrame,PACKET_STRUCT.CONSOLE_FRAME.SIZE),PACKET_STRUCT.CONSOLE_FRAME.START),f.set(g._numToBytes(a.opcode,PACKET_STRUCT.OPCODE.SIZE),PACKET_STRUCT.OPCODE.START),d?f.set(g._numToBytes(0,
PACKET_STRUCT.PACKET_LEN.SIZE),PACKET_STRUCT.PACKET_LEN.START):f.set(g._numToBytes(c.byteLength,PACKET_STRUCT.PACKET_LEN.SIZE),PACKET_STRUCT.PACKET_LEN.START),f.set(g._numToBytes(a.version,PACKET_STRUCT.VERSION.SIZE),PACKET_STRUCT.VERSION.START),f.set(g._numToBytes(a.seqId,PACKET_STRUCT.SEQ_ID.SIZE),PACKET_STRUCT.SEQ_ID.START),f=d?f:g._concatUint8Array(f,new Uint8Array(c)),g._ws.send(f))};f.readAsArrayBuffer(e)};
...
function binb_sha1(a,c){a[c>>5]|=128<<24-c%32;a[(c+64>>9<<4)+15]=c;for(var d=Array(80),e=1732584193,f=-271733879,g=-1732584194,k=271733878,q=-1009589776,t=0;t<a.length;t+=16){for(var v=e,s=f,D=g,F=k,C=q,z=0;80>z;z++){d[z]=16>z?a[t+z]:bit_rol(d[z-3]^d[z-8]^d[z-14]^d[z-16],1);var l=safe_add(safe_add(bit_rol(e,5),sha1_ft(z,f,g,k)),safe_add(safe_add(q,d[z]),sha1_kt(z))),q=k,k=g,g=bit_rol(f,30),f=e,e=l}e=safe_add(e,v);f=safe_add(f,s);g=safe_add(g,D);k=safe_add(k,F);q=safe_add(q,C)}return[e,f,g,k,q]}
...
function rstr2any(a,c){var d=c.length,e,f,g,k,q,t=Array(Math.ceil(a.length/2));for(e=0;e<t.length;e++)t[e]=a.charCodeAt(2*e)<<8|a.charCodeAt(2*e+1);var v=Math.ceil(8*a.length/(Math.log(c.length)/Math.log(2))),s=Array(v);for(f=0;f<v;f++){q=[];for(e=k=0;e<t.length;e++)if(k=(k<<16)+t[e],g=Math.floor(k/d),k-=g*d,0<q.length||0<g)q[q.length]=g;s[f]=k;t=q}d="";for(e=s.length-1;0<=e;e--)d+=c.charAt(s[e]);return d}
...
chat_info:{},content_type:"avatar"==a.contentType?"avatar":"image"==a.contentType?8:4,file_dialog_start_handler:function(){},file_queued_handler:function(c){var e=a.getChatInfo&&a.getChatInfo()||{},f=YYIMChat.getServletPath().FILE_UPLOAD_SERVLET,g,k,q,t=e.to||YYIMChat.getUserNode();YYIMChat.isAnonymous()?(g=YYIMChat.getUserFullJID(),q="anonymous"):(g=YYIMChat.getUserNode(),q=YYIMChat.getToken());k=e.resource&&"anonymous"==e.resource.toLowerCase()?YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getID(t),
"ANONYMOUS"):YYIMChat.getJIDUtil().getNode(t);f=f+"?fileName="+encodeURI(c.name,"utf-8")+"&uploadedSize=0&fileSize="+c.size+"&fromUser="+g+"&toUser="+k+"&token="+q+"&muc=1";"avatar"===a.contentType&&(f+="&isAvatar=true");this.settings.chat_info={to:YYIMChat.getJIDUtil().getNode(t),type:e.type?e.type:"chat",resource:e.resource};this.setUploadURL(f)},file_queue_error_handler:function(){a.error&&a.error(arguments)},file_dialog_complete_handler:function(){this.startUpload()},upload_start_handler:function(){},
...
breakPoints:!0,fileSplitSize:10485760,getUploadedSize:null,saveUploadedSize:null,saveInfoLocal:!0,onUploadStart:null,onUploadSuccess:null,onUploadComplete:null,onUploadError:null,onInit:null,onCancel:null,onSelect:null,uploadIdPrefix:"file_upload_",inputId:null,to:null,type:4,chatType:"chat",showProcess:!1,processId:null,resource:null},a),d=function(a,d,g,k,q,t){parseInt(SNSStorage.getLocalVal(g.name));YYIMChat.isAnonymous()?YYIMChat.getUserFullJID():(YYIMChat.getUserNode(),YYIMChat.getToken());c.resource&&
"anonymous"==c.resource.toLowerCase()?YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getID(t),"ANONYMOUS"):"groupchat"==c.chatType?YYIMChat.getJIDUtil().buildChatGroupJID(YYIMChat.getJIDUtil().getNode(t)):YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getNode(t));encodeURI(g.name,"utf-8");a=YYIMChat.getServletPath().REST_RESOURCE_SERVLET+YYIMChat.getTenancy().ETP_KEY+"/"+YYIMChat.getTenancy().APP_KEY+"/upload?token="+YYIMChat.getToken();q={name:encodeURI(g.name,"utf-8"),mediaType:8===
c.type?1:2,creator:YYIMChat.getUserNode(),receiver:YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getNode(t)),size:q,original:1};"groupchat"==c.chatType&&(q.receiver=YYIMChat.getJIDUtil().buildChatGroupJID(YYIMChat.getJIDUtil().getNode(t)));a+="&"+jQuery.param(q);YYIMChat.log("file upload url",2,a);d.open(c.method,a,!0);d.setRequestHeader("X-Requested-With","XMLHttpRequest");a=new FormData;a.append(c.fileObjName,g);if(k)for(key in k)a.append(key,k[key]);d.send(a)};this.each(function(){var a=
jQuery(this),f=jQuery(".uploadify").length+1,g='<span id="'+c.uploadIdPrefix+f+'-queue" class="uploadify-queue"></span>',k=jQuery("#"+c.processId);0>=jQuery("#"+c.uploadIdPrefix+f+"-queue").length&&c.showProcess&&k.append(g);FileUpload.getInstanceByInputId(c.inputId).fileObj={uploadAllowed:!0,fileInput:a,uploadFileList:k.find("#"+c.uploadIdPrefix+f+"-queue"),url:c.uploader,fileFilter:[],uploadOver:!1,filter:function(a){for(var d=[],f=c.fileTypeExts.split(";"),e=0,g=a.length;e<g;e++){var k=a[e];parseInt(FileUpload.formatFileSize(k.size,
!0))>c.fileSizeLimit?alert("\u6587\u4ef6"+k.name+"\u5927\u5c0f\u8d85\u51fa\u9650\u5236\uff01"):"*"==c.fileTypeExts||0<=jQuery.inArray(k.name.split(".").pop().toLowerCase(),f)?d.push(k):alert("\u6587\u4ef6"+k.name+"\u7c7b\u578b\u4e0d\u5141\u8bb8\uff01")}return d},funSelect:function(d){for(var g=0,k=d.length;g<k;g++){var s=d[g];filesIndex+=","+s.index;var D="unknown";s.name&&(D=s.name.substr(s.name.lastIndexOf(".")+1));D=jQuery(c.itemTemplate.replace(/\${fileID}/g,"fileupload_"+f+"_"+s.index).replace(/\${fileTypeIcon}/g,
"res/skin/default/icons/filetype/"+D+".png").replace(/\${fileName}/g,s.name).replace(/\${fileSize}/g,FileUpload.formatFileSize(s.size)).replace(/\${instanceID}/g,a.attr("id")).replace(/\${continueUpload}/g,"continueUpload_"+f+"_"+s.index));c.auto&&D.find(".uploadbtn").remove();var F=0,C="0KB",z="0%";c.breakPoints&&(z=this.funGetUploadedSize(s),F=z/s.size*100+"%",C=FileUpload.formatFileSize(z),z=(z/s.size*100).toFixed(2)+"%",D.find(".uploadify-progress-bar").css("width",F));this.uploadFileList.append(D);
c.showUploadedSize&&(F='<span class="progressnum"><span id="isUploadingFileSize_'+f+"_"+s.index+'" class="uploadedsize">'+C+'</span>/<span class="totalsize">${fileSize}</span></span>'.replace(/\${fileSize}/g,FileUpload.formatFileSize(s.size)),D.find(".uploadify-progress").after(F));c.showUploadedPercent&&(F='<span class="up_percent" style="display:none">'+z+"</span>",D.find(".uploadify-progress").after(F));c.onSelect&&c.onSelect(d);c.auto?this.funUploadFile(s):D.find(".uploadbtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(s));
D.find(".delfilebtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funDeleteFile(a)}}(s));D.find("#btnstop").click(function(a){return function(){deletefilesIndex+=","+a.index}}(s));D.find("#continueUpload_"+f+"_"+s.index).click(function(a){var d=a.index;return function(){if(0<deletefilesIndex.length&&-1<deletefilesIndex.indexOf(","+d)){for(var a=deletefilesIndex.split(","),f="",e=0;e<a.length;e++)a[e]!=d&&""!=a[e]&&(f+=","+a[e]);deletefilesIndex=f}(a=FileUpload.getFile(d,
FileUpload.getInstanceByInputId(c.inputId).fileObj.fileFilter))&&FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(s))}},onProgress:function(a,d,e){a=k.find("#fileupload_"+f+"_"+a.index+" .uploadify-progress").attr("lastLoaded")||0;d<a&&(a=0);d-=parseInt(a);a=(d/e).toFixed(4);a=1<a?1:a;c.onUploadProgress&&c.onUploadProgress({percent:a,loaded:d,total:e})},funGetProgressWidth:function(a){},funGetUploadedSize:function(a){if(c.getUploadedSize)return c.getUploadedSize(a);if(c.saveInfoLocal)return parseInt(SNSStorage.getLocalVal(a.name))||
0},funSaveUploadedSize:function(a,d,f){c.saveUploadedSize?c.saveUploadedSize(a,d):c.saveInfoLocal&&!f&&SNSStorage.setLocal(a.name,d)},funSendFile:function(a){a=a.files;a=this.filter(a);for(var c=0,d=a.length;c<d;c++)this.fileFilter.push(a[c]);this.funDealFiles(a);return this},funDealFiles:function(a){for(var c=k.find(".uploadify-queue .uploadify-queue-item").length,d=0,e=a.length;d<e;d++)a[d].index=++c,a[d].id="fileupload_"+f+"_"+a[d].index;this.funSelect(a);return this},funDeleteFile:function(a){c.breakPoints&&
...
isDelete=!0}});return this},funUploadFile:function(a){var e=!1,g=a,s=k.find("#fileupload_"+f+"_"+a.index),D=function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(s.find(".uploadify-progress-bar").css("width","100%"),c.showUploadedSize&&s.find(".uploadedsize").text(s.find(".totalsize").text()),c.showUploadedPercent&&s.find(".up_percent").text("100%"))};try{e=new XMLHttpRequest}catch(F){e=ActiveXobject("Msxml12.XMLHTTP")}if("undefined"==e)alert("\u6d4f\u89c8\u5668\u7248\u672c\u4e0d\u652f\u6301\uff0c\u8bf7\u66f4\u65b0\u7248\u672c");
else{31457280>=g.size||-1<g.type.indexOf("image/")?c.breakPoints=!1:c.breakPoints=!0;if(c.breakPoints){var C=a.name,z=a.id,l=a.index,A=a.size,n=parseInt(this.funGetUploadedSize(g));if(browserSys.firefox){var x=browserSys.firefox.split(".");a=6<x[0]&&15>x[0]?g.mozSlice(n,n+c.fileSplitSize):g.slice(n,n+c.fileSplitSize)}else browserSys.chrome?(x=browserSys.chrome.split("."),a=10<x[0]&&21>x[0]?g.webkitSlice(n,n+c.fileSplitSize):g.slice(n,n+c.fileSplitSize)):a=g.slice(n,n+c.fileSplitSize);a.name=C;a.id=
z;a.index=l}e.upload&&!1!==n&&e.upload.addEventListener("progress",function(d){FileUpload.getInstanceByInputId(c.inputId).fileObj.onProgress(a,d.loaded,g.size)},!1);var r=c.to;g.userJid=r;e.onreadystatechange=function(s){if(4==e.readyState){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!0;if(200==e.status){s=JSON.parse(e.responseText);"success"==s.status&&(setTimeout(function(){k.find("#fileupload_"+f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name));var x=g.index;c.breakPoints?
(n+=c.fileSplitSize,"success"==s.status||isDelete?(FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,n,!0),isDelete=!1):FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,n,!1),-1<deletefilesIndex.indexOf(x)&&SNSStorage.removeLocal(g.name),n<A?(FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!1,-1<filesIndex.indexOf(","+x)&&-1==deletefilesIndex.indexOf(x)&&(browserSys.firefox?(x=browserSys.firefox.split("."),a=6<x[0]&&15>x[0]?g.mozSlice(n,
n+c.fileSplitSize):g.slice(n,n+c.fileSplitSize)):browserSys.chrome?(x=browserSys.chrome.split("."),a=10<x[0]&&21>x[0]?g.webkitSlice(n,n+c.fileSplitSize):g.slice(n,n+c.fileSplitSize)):a=g.slice(n,n+c.fileSplitSize),a.name=C,a.id=z,a.index=l,a.size=A,d(FileUpload.getInstanceByInputId(c.inputId).fileObj.url,e,a,c.formData,g.size,r))):D()):D();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.type==UPLOAD_AVATAR?c.onUploadSuccess&&c.onUploadSuccess(s):(s={id:Math.uuid(),body:{content:new SNSFile(a.name,
s.attachId,a.size),contentType:c.type,dateline:(new Date).getTime()},to:c.to,type:c.chatType,success:function(a){var d=Object.clone(a);d.to=YYIMChat.getJIDUtil().getID(a.to);c.onUploadSuccess&&c.onUploadSuccess(d)}},c.resource&&(s.resource=c.resource),YYIMChat.sendMessage(s)),setTimeout(function(){k.find("#fileupload_"+f+"_"+g.index).fadeOut()},c.removeTimeout))}else FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&c.onUploadError&&c.onUploadError(g,e.responseText),setTimeout(function(){k.find("#fileupload_"+
f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name);FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.onUploadComplete&&c.onUploadComplete(g,e.responseText),FileUpload.getInstanceByInputId(c.inputId).fileObj.fileInput.val(""))}};c.onUploadStart&&c.onUploadStart();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadAllowed=!0;d(this.url,e,a,c.formData,g.size,r)}}};c.onInit&&c.onInit()})}
...
-1!=a.indexOf("@")?a:a+"@"+l.DOMAIN.PUBACCOUNT:null},getChatTypeByJid:function(a){if(a)switch(f.getDomain(a)){case l.DOMAIN.CHATROOM:return n.GROUP_CHAT;case l.DOMAIN.PUBACCOUNT:return n.PUB_ACCOUNT;default:return n.CHAT}}},g="im.yyuap.com",k="stellar.yyuap.com",q=5227,t=7075,v="http://im.yyuap.com/",s="https://im.yyuap.com/";jQuery.support.cors=!0;var D={FILE_UPLOAD_SERVLET:v+"sysadmin/fileUpload",FILE_DOWNLOAD_SERVLET:v+"sysadmin/download",FILE_DELETE_SERVLET:v+"sysadmin/cancel",AVATAR_SERVLET:v+
"sysadmin/avatar",REST_RESOURCE_SERVLET:v+"sysadmin/rest/resource/",REST_HISTORY_SERVLET:v+"sysadmin/rest/history/",REST_VERSION_SERVLET:v+"sysadmin/rest/version/",REST_USER_SERVLET:v+"sysadmin/rest/user/",REST_UPLOAD_SERVLET:v+"im_upload/rest/resource/",REST_DOWNLOAD_SERVLET:v+"im_download/rest/resource/",REST_TRANSFORM_SERVLET:v+"im_download/rest/transform/resource/",REST_USER_SERVLET_SAFE:s+"sysadmin/rest/user/",REST_SYSTEM_SERVLET_SAFE:s+"sysadmin/rest/system/"},F={VENDORKEY:s+"sysadmin/rest/user/phosvraccount/",
ROLE:{MODERATOR:"moderator",PARTICIPANS:"participans",SERVER:"server"},OPERATE:{CREATE:{name:"create",power:["moderator"]},INVITE:{name:"invite",power:["moderator","participans"]},JOIN:{name:"join",power:["participans"]},EXIT:{name:"exit",power:["participans"]},MUTE:{name:"mute",power:["moderator"]},MUTEALL:{name:"muteAll",power:["moderator"]},CANCELMUTE:{name:"cancelMute",power:["moderator"]},CANCELMUTEALL:{name:"cancelMuteAll",power:["moderator"]},KICK:{name:"kick",power:["moderator"]},ROLECONVERSION:{name:"roleConversion",
power:["moderator"]},SWITCHVOICE:{name:"switchvoice",power:["moderator"]},SWITCHVIDEO:{name:"switchVideo",power:["moderator"]},END:{name:"end",power:["moderator"]},AGREE:{name:"agree",power:["participans"]},REFUSE:{name:"refuse",power:["participans"]},LOCK:{name:"lock",power:["moderator"]},UNLOCK:{name:"unlock",power:["moderator"]},OPENVIDEO:{name:"openVideo",power:["moderator","participans"]},CLOSEVIDEO:{name:"closeVideo",power:["moderator","participans"]},OPENMICROPHONE:{name:"openMicrophone",power:["moderator",
"participans"]},CLOSEMICROPHONE:{name:"closeMicrophone",power:["moderator","participans"]},BUSY:{name:"busy",power:["participans"]},TIMEOUT:{name:"timeout",power:["server"]},EDITTOPIC:{name:"editTopic",power:["moderator"]},INIT:{name:"init",power:["moderator"]}},ROOMSTATUS:{LOCK:"lock",MUTEALL:"muteAll",END:"end"},MEMEBERSTATUS:{VIDEOCLOSED:"videoClosed",MUTE:"mute",MUZZLED:"muzzled"},MEMEBERJOINSTATUS:{INIT:"init",INVITING:"inviting",JOINED:"joined",TIMEOUT:"timeout",BUSY:"busy",REFUSE:"refuse",
EXIT:"exit"},CONFERENCETYPE:{SINGLECHAT:"singleChat",GROUPCHAT:"groupChat",CONFERENCE:"conference",LIVE:"live",RESERVATION:"reservation"},CONFERENCEMODE:{VIDEO:"video",VOICE:"voice"}},C;-1<navigator.userAgent.indexOf("Safari")&&1>navigator.userAgent.indexOf("Chrome")?C=!1:(window.WebSocket=window.WebSocket||window.MozWebSocket,C=window.WebSocket?!0:!1);var z;z=window.localStorage?!0:!1;var l={RESOURCE:"web-v2.6",IS_ANONYMOUS:!0,MULTI_TENANCY:{ENABLE:!0,ETP_KEY:"etp",APP_KEY:"app",SEPARATOR:"."},RECEIPTSPACKET_AUTO:!1,
SENDINTERVAL:30,RECENTCONTACTSDAY:7,RECENTCONTACTSNUM:20,RECENTCONTACTSMODE:{CONTACTNUM:{NAME:"number",DEFAULT:7},CONTACTDAYS:{NAME:"days",DEFAULT:20}},TIMECORRECTION:{AUTOCORRECTION:!1,TIMES:3,RESIDUAL:50,RESULT:0},MULTIPARTYCALL:{ADDRESS:"http://dudu.yonyoutelecom.cn/httpIntf/createConference.do",ACCOUNT:"",KEY:"",PHONESMAXLENGTH:200},SERVLET:D,NETMEETING:F,SUPPORT:{isWebSocketSupport:C,isLocalConnectionSupport:z},CONNECTION:{TIMERVAL:2E3,WAIT:300,SECURE:!1,ALLOW_PLAIN:!0,ENABLE_WEBSOCKET:!0,ENABLE_LOCAL_CONNECTION:!0,
USE_HTTPS:!1,SERVER_NAME:g,HTTP_BASE:k,HTTP_BIND_PORT:t,WS_PORT:q},PING:{INTERVAL:3E4,DURATION:3E4,TIMEOUT:3E4},DOMAIN:{CHATROOM:"conference."+g,SEARCH:"search."+g,PUBACCOUNT:"pubaccount."+g},MESSAGE:{SEND_TIMEOUT:3E4,MAX_CHARACHER:1E3,REQUEST_RECEIPTS:!0},LOG:{ENABLE:!0,FILTER_LEVEL:3},BROWSER:function(){var a=navigator.userAgent.toLowerCase();return{version:(a.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/)||[])[1],safari:/webkit/.test(a),opera:/opera/.test(a),msie:/msie/.test(a)&&!/opera/.test(a),mozilla:/mozilla/.test(a)&&
!/(compatible|webkit)/.test(a)}}(),getHttpBindUrl:function(){return(this.CONNECTION.USE_HTTPS?"https://":"http://")+this.CONNECTION.HTTP_BASE+":"+this.CONNECTION.HTTP_BIND_PORT+"/http-bind/"},getWebSocketUrl:function(){return(this.CONNECTION.USE_HTTPS?"wss://":"ws://")+this.CONNECTION.HTTP_BASE+":"+this.CONNECTION.WS_PORT},useWebSocket:function(){return this.SUPPORT.isWebSocketSupport&&this.CONNECTION.ENABLE_WEBSOCKET},useLocalConnection:function(){return this.SUPPORT.isLocalConnectionSupport&&this.CONNECTION.ENABLE_LOCAL_CONNECTION},
getConnectionArgObj:function(){var a={domain:this.CONNECTION.SERVER_NAME,resource:this.RESOURCE,allow_plain:this.CONNECTION.ALLOW_PLAIN,secure:this.CONNECTION.SECURE,register:!1};this.IS_ANONYMOUS&&(a.authtype="saslanon");return a}},A={CHAT:"chat",AWAY:"away",XA:"xa",DND:"dnd",UNAVAILABLE:"unavailable"},n={CHAT:"chat",GROUP_CHAT:"groupchat",DEVICE:"device",PUB_ACCOUNT:"pubaccount"},x={MIXED:"mixed",SIMPLE:"simple",TEXT:2,FILE:4,IMAGE:8,REVOCATION:13,SYSTEM:16,PUBLIC:32,AUDO:64,LOCATION:128,SHARE:256,
WHITEBOARD:1024,NETMEETING:2048},r=function(){var a=function(){return{getVCard:function(a){var c={type:"get"};YYIMCommonUtil.isStringAndNotEmpty(a.jid)?c.to=a.jid:null;d.getInstance().send(new JumpPacket(c,OPCODE.VCARD.SEND),function(a,c){c.complete&&c.complete();var d=a.vcard||{};d.id=d.userId=f.getID(d.username);a.enableFields&&(d.enableFields=a.enableFields);c.success&&c.success(d)},a)},setVCard:function(a){d.getInstance().send(new JumpPacket({type:"set",vcard:a.vcard},OPCODE.VCARD.SEND),function(a,
c){c.complete&&c.complete();c.success&&c.success()},a)},setTag:function(a){var c;c=a.id&&a.id!==h.getInstance().getUserID()?l.SERVLET.REST_USER_SERVLET_SAFE+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/"+a.id+"/roster/tag?token="+h.getInstance().getToken():l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/vcard/tag?token="+h.getInstance().getToken();jQuery.ajax({url:c,type:"post",data:JSON.stringify({tag:a.tag}),
dataType:"json",cache:!1,processData:!1,contentType:"application/json",success:function(c){a.success&&a.success(a.id)},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(m){a.error&&a.error()}}})},removeTag:function(a){var c;c=a.id&&a.id!==h.getInstance().getUserID()?l.SERVLET.REST_USER_SERVLET_SAFE+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/"+a.id+"/roster/tag?token="+h.getInstance().getToken()+"&tag="+JSON.stringify(a.tag):
l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/vcard/tag?token="+h.getInstance().getToken()+"&tag="+JSON.stringify(a.tag);jQuery.ajax({url:c,type:"delete",dataType:"json",cache:!1,success:function(c){a.success&&a.success(a.id)},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(m){a.error&&a.error()}}})},getVCards:function(a){d.getInstance().send(new JumpPacket({type:"roster"},OPCODE.VCARDS.SEND),function(a,
c){var d=a.vcards||[];vcards=[];for(i=d.length;i--;){var m=d[i];m.id=m.userId=f.getID(m.username);vcards.push(m)}c.complete&&c.complete();c.success&&c.success(vcards)},a)},getRostersPresence:function(a){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/presence/detail?token="+h.getInstance().getToken()+"&username="+a.username,type:"get",dataType:"json",cache:!1,success:function(c){a.success&&a.success(c)},error:function(){a.error&&
a.error()},complete:function(){a.complete&&a.complete()}})},getRecentContacts:function(a){var c={token:h.getInstance().getToken(),username:h.getInstance().getUserID()},d=l.SERVLET.REST_USER_SERVLET+"recentcontact/"+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY;a=a||{};a.mode=a.mode||l.RECENTCONTACTSMODE.CONTACTDAYS.NAME;if(a.mode===l.RECENTCONTACTSMODE.CONTACTNUM.NAME)d+="/recent/contacts",c.contactsCount="number"==typeof a.contactsCount&&0<a.contactsCount?a.contactsCount:l.RECENTCONTACTSMODE.CONTACTNUM.DEFAULT;
else{var d=d+"/recentContacts",m=(new Date).getTime();c.startDate=m-864E5*("number"==typeof a.contactsDays&&0<a.contactsDays?a.contactsDays:l.RECENTCONTACTSMODE.CONTACTDAYS.DEFAULT);c.endDate=m}jQuery.ajax({url:d,type:"get",dataType:"json",data:c,cache:!1,success:function(c){var d=[],m;for(m in c)c[m].username&&d.push({id:f.getID(c[m].username),dateline:c[m].lastContactDate});d=d.sort(YYIMUtil.array.comparisonAsc("dateline"));a.success&&a.success(d)},error:function(){a.error&&a.error()},complete:function(){a.complete&&
a.complete()}})},getRecentDigset:function(a){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/contactsmessage/digest?token="+h.getInstance().getToken(),type:"get",dataType:"json",cache:!1,success:function(c){if(c&&c.code)a.error&&a.error(c.code);else{for(var d in c.list)if(c.list[d].jid){c.list[d].id=f.getID(c.list[d].jid);c.list[d].type=f.getChatTypeByJid(c.list[d].jid);try{if(c.list[d].lastMessage){var m=c.list[d],
e=JSON.parse(c.list[d].lastMessage),y=c.list[d].type,g=void 0;try{g=JSON.parse(e.content)}catch(k){g=e.content}var l={content:g.content||g,contentType:e.contentType,dateline:e.dateline||e.ts,atuser:g.atuser,extend:g.extend},N=y!=n.GROUP_CHAT?f.getID(e.sender||e.pubaccount):{room:f.getID(e.mucid),roster:f.getID(f.getResource(e.sender))},K={id:e.id,type:y,from:N,data:l};K.to=y==n.CHAT?f.getID(e.receiver||e.to):h.getInstance().getUserID();K.data.content&&K.data.content.path&&(K.data.content.attachId=
K.data.content.path,K.data.content.path=YYIMChat.getFileUrl(K.data.content.path));m.lastMessage=K}}catch(q){}}a.success&&a.success(c.list||[])}},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})}}}(),c=function(){return{getRosterItems:function(a){var c=new JumpPacket({},OPCODE.ROSTER_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();for(var d=a.items||[],m=[],e=d.length||0,y={};e--;){var g=d[e],k=g.jid,g={id:f.getID(k),resource:f.getResource(k),
ask:g.ask,recv:g.recv,name:g.name,photo:g.photo,subscription:g.subscription,group:g.groups,tag:g.tag};f.getDomain(k)!==l.DOMAIN.PUBACCOUNT&&(m.push(g),y[g.id]||"none"!==g.subscription||1!==g.recv||(y[g.id]=g))}for(var N in y)if(y[N].id)h.getInstance().onSubscribe({from:y[N].id,type:"subscribe"});c.success&&c.success(JSON.stringify(m))}},a)},deleteRosterItem:function(a){var c={type:"set",ns:NS_ROSTER,item:{jid:a.jid,subscription:"remove"}};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_ROSTER.SEND),
function(a,c){c.complete&&c.complete();c.success&&c.success(f.getID(c.jid))},a)},queryRosterItem:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Username","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_USER.SEND),function(a,c){for(var d=a.items||[],m=[],e=d.length;e--;){var g=d[e],y=g.jid;y!==h.getInstance().getUserBareJID()&&m.push({id:f.getID(y),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?
g.name:f.getID(y),photo:g.photo,email:g.email})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:m})},a)},updateRosterItem:function(a){for(var c=a.roster,m={item:{jid:c.jid,name:c.name,groups:[]}},e=(c=c.groups)?c.length:0;e--&&YYIMCommonUtil.isStringAndNotEmpty(c[e]);)m.item.groups=m.item.groups.concat(c[e]);d.getInstance().send(new JumpPacket(m,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&c.complete();400===a.code?c.error&&c.error(a):(a.to=f.getID(a.to),c.success&&
c.success(a))},a)}}}(),e=function(){function a(c){if(c){for(var d=c.members.length,m=[];d--;){var e=c.members[d];e.id=f.getID(e.jid);m.push(e)}return{id:f.getID(c.from),name:c.naturalLanguageName||c.name,photo:c.photo,numberOfMembers:c.numberOfMembers,superLarge:c.superLarge,collected:c.collected,type:c.type,creationdate:c.creationdate,creater:f.getID(c.operator),members:m,owners:c.owners,tag:c.tag}}}function c(a){if(a){for(var d=a.memberItems.length,m=[];d--;){var e=a.memberItems[d];e.id=f.getID(e.jid);
m.push(e)}return{id:f.getID(a.from),members:m}}}return{queryChatGroup:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_CHATGROUP.SEND),function(a,c){for(var d=a.items||[],m=[],e=d.length;e--;){var g=d[e],y=g.jid;m.push({id:f.getID(y),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(y)})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,
items:m})},a)},configChatGroup:function(a){var c={to:a.jid,roomname:a.name,roomdesc:a.desc,persistent:1,owners:[h.getInstance().getUserBareJID()],etp:l.MULTI_TENANCY.ETP_KEY,app:l.MULTI_TENANCY.APP_KEY};YYIMCommonUtil.isStringAndNotEmpty(a.photo)&&(c.photo=a.photo);d.getInstance().send(new JumpPacket(c,OPCODE.CONFIG_CHATGROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success()},a)},getChatGroups:function(c){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+
"/rooms?token="+h.getInstance().getToken()+"&username="+h.getInstance().getUserID(),type:"get",dataType:"json",cache:!1,success:function(d){d=d.items||[];for(var m=[],e=d.length||0;e--;){var f=d[e];f.from=f.jid;(f=a(f))&&m.push(f)}c.success&&c.success(JSON.stringify(m))},error:function(){c.error&&c.error()},complete:function(){c.complete&&c.complete()}})},getChatGroupInfo:function(a){var c={to:a.jid,type:"get",ns:NS_DISCO_INFO};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP_INFO.SEND),function(a,
c){c.complete&&c.complete();var d=a.roomname?a.roomname:f.getID(c.jid),m=a.description;c.success&&c.success({name:d,desc:m})},a)},createChatGroup:function(c){var m={id:c.id,to:c.to,naturalLanguageName:c.name,from:h.getInstance().getUserBareJID(),invitees:c.members};d.getInstance().send(new JumpPacket(m,OPCODE.CREATE_GROUP.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},inviteGroupMember:function(c){var m={id:c.id,to:c.to,from:h.getInstance().getUserBareJID(),invitees:c.members};
d.getInstance().send(new JumpPacket(m,OPCODE.INVITE_GROUP_MEMBER.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},modifyChatGroupInfo:function(c){var m={id:c.id,naturalLanguageName:c.name,from:h.getInstance().getUserBareJID(),to:c.to};d.getInstance().send(new JumpPacket(m,OPCODE.MODIFY_GROUP_INFO.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},kickGroupMember:function(c){var m={id:c.id,member:c.member,from:h.getInstance().getUserBareJID(),to:c.to};
...
to:a.to,type:a.type};d.getInstance().send(new JumpPacket(c,OPCODE.COLLECT_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({from:f.getID(c.to),id:a.id,to:h.getInstance().getUserID(),type:c.type,code:a.code,message:a.message})},a)},transferChatGroup:function(a){var m={id:a.id,to:a.to,from:h.getInstance().getUserBareJID(),newOwner:a.newOwner};d.getInstance().send(new JumpPacket(m,OPCODE.TRANSFER_GROUP.SEND),function(a,d){d.complete&&d.complete();d.success&&d.success(c(a))},a)},
dismissChatGroup:function(a){var c={id:a.id,to:a.to,from:h.getInstance().getUserBareJID()};d.getInstance().send(new JumpPacket(c,OPCODE.DISMISS_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({id:a.id,from:f.getID(a.from),to:f.getID(a.to)})},a)},getSharedFiles:function(a){var c=-1<[n.CHAT,n.GROUP_CHAT,n.PUB_ACCOUNT].indexOf(a.type)?a.type:n.CHAT,d=l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/shareattachment/persional/attachment/"+h.getInstance().getUserID()+
"/"+a.id;c==n.GROUP_CHAT&&(d=l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/shareattachment/room/attachment/"+a.id+"/"+h.getInstance().getUserID());jQuery.ajax({url:d,data:{token:h.getInstance().getToken(),fileType:-1<["file","image","microvideo"].indexOf(a.fileType)?a.fileType:"file",start:parseInt(a.start)||0,size:parseInt(a.size)||20},type:"get",dataType:"json",cache:!1,success:function(d){var m=d.list||[];for(i=m.length;i--;){var e=m[i];e.creator=f.getID(e.creator);
if(c==n.GROUP_CHAT)e.ownerId=f.getID(e.ownerId);else{var g=e.ownerId.split("::");g[0]=f.getID(g[0]);g[1]=f.getID(g[1]);e.ownerId=g}}a.success&&a.success(d)},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(m){a.error&&a.error()}},complete:function(){a.complete&&a.complete()}})}}}(),g=function(){return{getGroupMembers:function(a){d.getInstance().send(new JumpPacket({type:"get",ns:NS_DISCO_ITEMS,to:a.jid},OPCODE.CHATGROUP_MEMBER_LIST.SEND),function(a,c){if(c){c.complete&&
c.complete();var d=a.items;if(0!==(d&&d.length||0)){for(var m=[],e=-1,g=d.length;++e<g;){var y=d[e];m.push({id:f.getID(y.jid),name:y.name,photo:y.photo,affiliation:y.affiliation})}c.success&&c.success(JSON.stringify(m))}}},a)}}}(),k=function(){return{getPubAccountItems:function(a){var c=new JumpPacket({type:"get",ns:NS_PUBACCOUNT,to:l.DOMAIN.PUBACCOUNT},OPCODE.PUBACCOUNT_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();for(var d=a.items||[],m=d.length||0;m--;)d[m].id=
f.getID(d[m].jid);c.success&&c.success(JSON.stringify(d))}},a)},queryPubaccount:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Accountname","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_PUBACCOUNT.SEND),function(a,c){for(var d=a.items||[],m=[],e=d.length;e--;){var g=d[e],y=g.jid;m.push({id:f.getID(y),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(y),type:g.type})}c.complete&&
c.complete();c.success&&c.success({start:a.start,total:a.total,items:m})},a)}}}(),q=function(){return{fullSyncRoster:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_ROSTER.SEND))},deltaSyncRoster:function(a,c){var m={};0<a.length&&(m.removes=a);0<c.length&&(m.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(m,OPCODE.DELTA_SYNC_ROSTER.SEND))},fullSyncChatGroup:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_CHATGROUP.SEND))},
deltaSyncChatGroup:function(a,c){var m={};0<a.length&&(m.removes=a);0<c.length&&(m.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(m,OPCODE.DELTA_SYNC_CHATGROUP.SEND))}}}();return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.UPDATE_ROSTER.KEY,function(a){var c=a.item;a=f.getID(a.item.jid);"both"===c.subscription?(H.log("update or add: "+JSON.stringify(c)),c.id=a,h.getInstance().onRosterUpdateded(c)):"none"===c.subscription&&(H.log("delete: "+JSON.stringify(c)),
...
(a&&a.length||0)){for(var c=[],d=a.length;d--;){var m=a[d],e=m.jid,m={id:f.getID(e),name:YYIMCommonUtil.isStringAndNotEmpty(m.name)?m.name:f.getID(e),type:m.type};c.push(m)}h.getInstance().onPubaccountUpdate(c)}})},getVCard:a.getVCard,setVCard:a.setVCard,setTag:a.setTag,removeTag:a.removeTag,getVCards:a.getVCards,getRostersPresence:a.getRostersPresence,getRecentContacts:a.getRecentContacts,getRecentDigset:a.getRecentDigset,getRosterItems:c.getRosterItems,deleteRosterItem:c.deleteRosterItem,queryRosterItem:c.queryRosterItem,
updateRosterItem:c.updateRosterItem,queryChatGroup:e.queryChatGroup,configChatGroup:e.configChatGroup,getChatGroups:e.getChatGroups,getChatGroupInfo:e.getChatGroupInfo,createChatGroup:e.createChatGroup,inviteGroupMember:e.inviteGroupMember,modifyChatGroupInfo:e.modifyChatGroupInfo,kickGroupMember:e.kickGroupMember,exitChatGroup:e.exitChatGroup,collectChatGroup:e.collectChatGroup,transferChatGroup:e.transferChatGroup,dismissChatGroup:e.dismissChatGroup,getSharedFiles:e.getSharedFiles,getGroupMembers:g.getGroupMembers,
getPubAccountItems:k.getPubAccountItems,queryPubaccount:k.queryPubaccount,fullSyncRoster:q.fullSyncRoster,deltaSyncRoster:q.deltaSyncRoster,fullSyncChatGroup:q.fullSyncChatGroup,deltaSyncChatGroup:q.deltaSyncChatGroup}}(),I=function(){function a(c,d){if(!0!==t.get(c.id)){t.add(c.id,!0);d=d||f.getChatTypeByJid(c.from);c.to=f.getID(c.to);c.from=d!=n.GROUP_CHAT?f.getID(c.from):{room:f.getID(c.from),roster:f.getID(f.getResource(c.from))};c.type=d;c.attributes&&(c.attributes.receiver&&(c.attributes.receiver=
f.getID(c.attributes.receiver)),c.attributes.bareJID&&(c.attributes.bareJID={id:f.getID(c.attributes.bareJID),type:f.getChatTypeByJid(c.attributes.bareJID)}));try{h.getInstance().onTransparentMessage(c)}catch(m){YYIMChat.log("TransparentMessHandleError:",0,c)}}}function c(a,d){if(!0!==t.get(a.id)&&(t.add(a.id,!0),a.from!==h.getInstance().getUserFullJID())){var m;try{m=JSON.parse(a.content)}catch(y){m=a.content}var k={content:m.content,contentType:a.contentType,dateline:a.dateline,atuser:m.atuser,
extend:m.extend},p=d!=n.GROUP_CHAT?f.getID(a.from):{room:f.getID(a.from),roster:f.getID(f.getResource(a.from))},p={id:a.id,type:d,from:p,data:k};d==n.CHAT?(p.resource=f.getResource(a.from),p.to=f.getID(a.receiver||a.to)):p.to=h.getInstance().getUserID();if(!0===a.receipts){var q={to:a.from,id:a.id,sessionVersion:a.sessionVersion};!0===l.RECEIPTSPACKET_AUTO?(e(q),g(q)):k.receipt=q}if(k.contentType)switch(k.contentType){case x.TEXT:m.style&&(p.data.style=m.style);try{h.getInstance().onTextMessage(p)}catch(r){YYIMChat.log("textMessHandleError:",
0,p)}break;case x.IMAGE:p.data&&p.data.content&&p.data.content.path&&(p.data.content.attachId=p.data.content.path,p.data.content.path=YYIMChat.getFileUrl(p.data.content.path));try{h.getInstance().onPictureMessage(p)}catch(s){YYIMChat.log("imageMessHandleError:",0,p)}break;case x.FILE:p.data&&p.data.content&&p.data.content.path&&(p.data.content.attachId=p.data.content.path,p.data.content.path=YYIMChat.getFileUrl(p.data.content.path));try{h.getInstance().onFileMessage(p)}catch(u){YYIMChat.log("fileMessHandleError:",
0,p)}break;case x.SHARE:try{h.getInstance().onShareMessage(p)}catch(v){YYIMChat.log("shareMessHandleError:",0,p)}break;case x.SYSTEM:p.data.content=m;p.data&&p.data.content&&p.data.content.path&&(p.data.content.attachId=p.data.content.path,p.data.content.path=YYIMChat.getFileUrl(p.data.content.path));try{h.getInstance().onSystemMessage(p)}catch(w){YYIMChat.log("systemMessHandleError:",0,p)}break;case x.PUBLIC:!m.content&&m.length&&(p.data.content=m);try{h.getInstance().onPublicMessage(p)}catch(R){YYIMChat.log("publicMessHandleError:",
0,p)}break;case x.AUDO:p.data&&p.data.content&&p.data.content.path&&(p.data.content.attachId=p.data.content.path,p.data.content.path=YYIMChat.getFileUrl(p.data.content.path));try{h.getInstance().onAudoMessage(p)}catch(z){YYIMChat.log("AudoMessHandleError:",0,p)}break;case x.LOCATION:p.data&&p.data.content&&p.data.content.path&&(p.data.content.attachId=p.data.content.path,p.data.content.path=YYIMChat.getFileUrl(p.data.content.path));try{h.getInstance().onLocationMessage(p)}catch(A){YYIMChat.log("LocationMessHandleError:",
0,p)}break;case x.WHITEBOARD:try{h.getInstance().onWhiteBoardMessage(p)}catch(B){YYIMChat.log("WhiteBoardMessHandleError:",0,p)}break;case x.NETMEETING:p.data&&p.data.content&&p.data.content.creator&&(p.data.content.creator=f.getID(p.data.content.creator));p.data&&p.data.content&&p.data.content.operator&&(p.data.content.operator=f.getID(p.data.content.operator));h.getInstance().onNetMeetingMessage(p);break;default:YYIMChat.log("unhandlePacketError:",0,p)}}}function e(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),
h.getInstance().getUserResource()),dateline:(new Date).getTime(),sessionVersion:a.sessionVersion,id:a.id},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function g(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),h.getInstance().getUserResource()),dateline:(new Date).getTime(),sessionVersion:a.sessionVersion,id:a.id,state:2},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function k(a,c,d){c={id:a.id,type:a.type,data:{content:c.content,contentType:c.contentType,dateline:d,extend:a.extend}};c.type===
n.GROUP_CHAT?(c.to=YYIMChat.getUserID(),c.from={room:f.getID(a.to),roster:YYIMChat.getUserID()}):(c.to=f.getID(a.to),c.from=YYIMChat.getUserID());c.body=c.data;c.data.content.path&&(c.data.content.attachId=c.data.content.path,c.data.content.path=YYIMChat.getFileUrl(c.data.content.path));a.style&&(c.data.style=a.style);return c}function q(a,c){if(l.RECEIPTSPACKET_AUTO){var d=l.SERVLET.REST_VERSION_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+c.id+"/ack?oldversion="+c.version+"&version="+
a.version+"&resource="+l.RESOURCE+"&token="+h.getInstance().getToken();jQuery.ajax({url:d,dataType:"json",type:"put",cache:!1,statusCode:{200:function(){h.getInstance().log("getVersion_sucess:",3,a.version)}}})}}function s(a){a.start||(a.start=0);a.size||(a.size=100);a.version||(a.version=-1);jQuery.ajax({url:l.SERVLET.REST_VERSION_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+a.id+"?version="+a.version+"&start="+a.start+"&size="+a.size+"&resource="+l.RESOURCE+"&token="+h.getInstance().getToken(),
dataType:"json",cache:!1,success:function(c){a.complete&&a.complete();if(c.packets&&c.packets.length){for(var d in c.packets)try{for(var m=c.packets[d],e=b64decode(m.opcode),f="0x",g=0;g<e.length;g++)var y=e[g].charCodeAt().toString(16),f=f+(1==y.length?"0"+y:y);var h=JSON.parse(m.body);h.opcode=f;r.unshift(h)}catch(k){}r.sort(YYIMUtil.array.comparisonAsc("dateline"));c.packets.length>=c.size?(a.start+=a.size,s(a)):u(c,a)}else c.packets&&c.packets.length||u(c,a)},error:function(c){h.getInstance().log("getOfflineMessage_error:",
0,c.statusText);a.error&&a.error()}})}function u(a,d){if(r.length){for(var m in r)if(r[m].id)switch(r[m].opcode){case "0x"+OPCODE.PRESENCE.SEND.toString(16):h.getInstance().onSubscribe({from:f.getID(r[m].from),type:r[m].type});break;case "0x"+OPCODE.USER_MESSAGE.SEND.toString(16):case "0x"+OPCODE.CHATGROUP_MESSAGE.SEND.toString(16):case "0x"+OPCODE.PUBACCOUNT_MESSAGE.SEND.toString(16):c(r[m],r[m].type);break;default:h.getInstance().log("unHandle_Packet:",3,r[m])}d.version=a.version-r.length;r=[];
q(a,d)}d.success&&d.success()}var t=new SNSBaseList,r=[];return{monitor:function(){var e=d.getInstance();e.registerHandler(OPCODE.USER_MESSAGE.KEY,function(a){c(a,a.type)});e.registerHandler(OPCODE.CHATGROUP_MESSAGE.KEY,function(a){c(a,a.type)});e.registerHandler(OPCODE.PUBACCOUNT_MESSAGE.KEY,function(a){c(a,a.type)});e.registerHandler(OPCODE.RECEIPTS.KEY,function(a){a.from=f.getID(a.from);a.to=f.getID(a.to);h.getInstance().onReceipts(a)});e.registerHandler(OPCODE.SYNC_MESSAGE.KEY,function(a){c(a,
a.type)});e.registerHandler(OPCODE.USERONLINEDELIVERPACKET.KEY,function(c){a(c,n.CHAT)});e.registerHandler(OPCODE.MUCONLINEDELIVERPACKET.KEY,function(c){a(c,n.GROUP_CHAT)});e.registerHandler(OPCODE.PUBONLINEDELIVERPACKET.KEY,function(c){a(c,n.PUB_ACCOUNT)});e.registerHandler(OPCODE.REMINDSETTINGONLINEDELIVERPACKET.KEY,function(c){a(c)})},sendMessage:function(a){var c,m=a.body||{},e={id:a.id,type:a.type||n.CHAT,contentType:m.contentType||x.TEXT,dateline:(new Date).getTime()+l.TIMECORRECTION.RESULT,
content:{atuser:m.atuser,extend:m.extend,content:m.content}},g=OPCODE.USER_MESSAGE.SEND;a.type==n.GROUP_CHAT?(c=f.buildChatGroupJID(f.getNode(a.to)),g=OPCODE.CHATGROUP_MESSAGE.SEND):a.type==n.PUB_ACCOUNT?(c=f.buildPubAccountJID(f.getNode(a.to)),g=OPCODE.PUBACCOUNT_MESSAGE.SEND):(e.receipts="1",c=a.resource?"anonymous"==a.resource.toLowerCase()?f.buildUserJID(f.getID(a.to),a.resource.toUpperCase()):a.to==YYIMChat.getUserID()?f.buildUserJID(f.getNode(a.to),a.resource):f.buildUserJID(f.getNode(a.to)):
f.buildUserJID(f.getNode(a.to)));e.to=c;a.style&&(e.content.style=a.style);d.getInstance().send(new JumpPacket(e,g),function(c){if(40302==c.code)a.error&&a.error();else if(l.TIMECORRECTION.AUTOCORRECTION){if(c&&1==c.state)h.getInstance().onReceipts(c)}else a.success&&a.success(k(a,m,c.dateline))});l.TIMECORRECTION.AUTOCORRECTION&&a.success&&a.success(k(a,m,e.dateline))},addGroupMember:function(a,c){d.getInstance().send(new JumpPacket({to:a,invites:c},OPCODE.INVITE_USERS.SEND))},getHistoryMessage:function(a){var c=
l.SERVLET.REST_HISTORY_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+YYIMChat.getUserID()+"?token="+h.getInstance().getToken()+"&start="+a.start+"&size="+a.num+"&peer=";if(a.chatType==n.GROUP_CHAT)c=l.SERVLET.REST_HISTORY_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/historymuc/"+a.id+"?token="+h.getInstance().getToken()+"&start="+a.start+"&size="+a.num;else if(a.chatType!=n.GROUP_CHAT&&(c=a.resource&&"anonymous"==a.resource?c+a.id:c+f.getNode(a.id),a.contentType))for(var d in x)if(a.contentType==
x[d]){c+="&contentType="+a.contentType;break}h.getInstance().log("\u5386\u53f2\u8bb0\u5f55\uff1arequest URL",2,c);jQuery.ajax({url:c,dataType:"json",cache:!1,success:function(c){YYIMChat.log("\u5386\u53f2\u8bb0\u5f55\uff1adata",2,c);for(var d=[],m=0;c.result&&m<c.result.length;m++){var e={fromId:f.getID(c.result[m].sender||c.result[m].pubaccount),toId:f.getID(c.result[m].receiver||h.getInstance().getUserID()),msgId:c.result[m].packetId||c.result[m].messageID,contentType:c.result[m].contentType,dateline:c.result[m].dateline||
c.result[m].ts,packetId:c.result[m].packetId||c.result[m].messageID,type:a.chatType};a.chatType&&a.chatType==n.GROUP_CHAT&&(e.messageID=c.result[m].packetId||c.result[m].messageID,e.fromId=f.getID(c.result[m].mucId),e.fromRoster=f.getID(c.result[m].sender),e.from={room:f.getID(c.result[m].mucId),roster:f.getID(c.result[m].sender)});if(c.result[m].content){e.body=e.body||{};try{var g;var y=c.result[m].content;if(y){var k=JSON.parse(y);try{isNaN(Number(k.content))&&(k.content=JSON.parse(k.content),
k.content.style&&(k.style=k.content.style,delete k.content.style),k.content.content&&(k.content=k.content.content))}catch(l){}g=k}else g=null;g&&g.content?e.body=g:e.body.content=g}catch(N){}e.body.contentType=c.result[m].contentType;e.body.dateline=c.result[m].dateline||c.result[m].ts;e.body.content&&e.body.contentType&&(e.body.contentType==x.IMAGE||e.body.contentType==x.FILE)&&(e.body.content.attachId=e.body.content.path,e.body.content.path=e.body.content.path?YYIMChat.getFileUrl(e.body.content.path):
null);d.push(e)}}YYIMCommonUtil.isFunction(a.success)&&a.success({count:Number(c.count),result:d})},error:function(c){a.error&&a.error();h.getInstance().log("getHistoryMessage_error:",0,c.statusText)},complete:function(){a.complete&&a.complete()}})},getOfflineMessage:s,revocationMessage:function(a){var c,d;a.type==n.GROUP_CHAT?(c=l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/revokeservice/groupmessage/"+a.id,d={token:h.getInstance().getToken(),userid:h.getInstance().getUserNode(),
mucid:f.getNode(a.to)}):(c=l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/revokeservice/personalmessage/"+a.id,d={token:h.getInstance().getToken(),fromuserid:h.getInstance().getUserNode(),touserid:f.getNode(a.to)});jQuery.ajax({url:c,data:jQuery.param(d),type:"put",cache:!1,success:function(c){c.detailCode?a.error&&a.error(c):a.success&&a.success({id:a.id})},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(m){a.error&&a.error()}},
complete:function(){a.complete&&a.complete()}})},sendReceiptsPacket:e,sendReadedReceiptsPacket:g}}(),G=function(){return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.PRESENCE.KEY,function(a){if(a.type&&"unavailable"!=a.type)h.getInstance().onSubscribe({from:f.getID(a.from),type:a.type});else{var c={from:f.getID(a.from),resource:f.getResource(a.from),type:a.type,show:a.show,status:a.status};B.getInstance().addToOnline(c.from);a.type&&"unavailable"==a.type&&(c.show=A.UNAVAILABLE,
c.status=A.UNAVAILABLE,B.getInstance().removeFromOnline(c.from));YYIMCommonUtil.isStringAndNotEmpty(c.status)||(c.show=A.CHAT,c.status=A.CHAT);h.getInstance().onPresence(c)}});a.registerHandler(OPCODE.CHATGROUP.KEY,function(a){if("unavailable"==a.type)h.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid)},type:"quit"});else h.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid),nick:a.name?a.name:f.getID(a.jid),affiliation:a.affiliation,role:a.role},
type:"join"})})},addRosterItem:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a},OPCODE.PRESENCE.SEND))},approveSubscribe:function(a){d.getInstance().send(new JumpPacket({type:"subscribed",to:a},OPCODE.PRESENCE.SEND))},rejectSubscribe:function(a){d.getInstance().send(new JumpPacket({type:"unsubscribed",to:a},OPCODE.PRESENCE.SEND))},setPresence:function(a){var c={};YYIMCommonUtil.isStringAndNotEmpty(a.show)&&(c.show=a.show);YYIMCommonUtil.isStringAndNotEmpty(a.status)&&(c.status=
a.status);YYIMCommonUtil.isStringAndNotEmpty(a.priority)&&(c.priority=a.priority);YYIMCommonUtil.isStringAndNotEmpty(a.type)&&(c.type=a.type);d.getInstance().send(new JumpPacket(c,OPCODE.PRESENCE.SEND))},addPubAccount:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a.jid},OPCODE.PRESENCE.SEND),function(a,c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to);c.success&&c.success(a)},a)},removePubAccount:function(a){d.getInstance().send(new JumpPacket({id:a.id,type:"unsubscribe",
to:a.to},OPCODE.PRESENCE.SEND),function(a,c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to)||h.getInstance().getUserID();c.success&&c.success(a)},a)},joinChatGroup:function(a){var c={to:a.jid+"/"+h.getInstance().getUserNode()};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP.SEND),function(c,d){a.complete&&a.complete();a.success&&a.success({id:f.getID(c.from),affiliation:c.affiliation,role:c.role})},a)},delGroupMember:function(a,c,e){var f=parseInt(1E5+1E5*Math.random());
0<c.indexOf("@")&&(c=c.split("@")[0]);d.getInstance().send(new JumpPacket({id:f,to:a,member:c,role:"none"},OPCODE.DEL_GROUPMEMBER.SEND),function(a){e&&e(a)})},quitChatGroup:function(a){d.getInstance().send(new JumpPacket({type:"unavailable",to:a+"/"+h.getInstance().getUserNode()},OPCODE.CHATGROUP.SEND),function(){})}}}(),J=function(){return{getProfile:function(a){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/profile?token="+
h.getInstance().getToken(),type:"get",cache:!1,datatype:"json",success:function(c){if(c.muteItems){var d={},e;for(e in c.muteItems){var g=f.getID(c.muteItems[e]),h=f.getChatTypeByJid(c.muteItems[e]);d[g]={id:g,type:h}}c.muteItems=d}if(c.stickItems){d={};for(e in c.stickItems)g=f.getID(c.stickItems[e]),h=f.getChatTypeByJid(c.stickItems[e]),d[g]={id:g,type:h};c.stickItems=d}c.userId&&(c.userId=f.getID(c.userId));a.success&&a.success(c)},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&
a.error(d)}catch(e){a.error&&a.error()}},complete:a.complete})},muteStick:function(a){var c;c=a.type==n.GROUP_CHAT?f.buildChatGroupJID(f.getNode(a.to)):a.type==n.PUB_ACCOUNT?f.buildPubAccountJID(f.getNode(a.to)):f.buildUserJID(f.getNode(a.to),h.getInstance().getUserResource());a.handle="mute"===a.handle?a.handle:"stick";jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/profile/"+a.handle+"?token="+h.getInstance().getToken(),
type:"post",data:JSON.stringify({bareJID:c}),dataType:"json",cache:!1,processData:!1,contentType:"application/json",success:function(c){a.success&&a.success({id:a.to,type:a.type})},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(e){a.error&&a.error()}},complete:a.complete})},cancelMuteStick:function(a){var c;c=a.type==n.GROUP_CHAT?f.buildChatGroupJID(f.getNode(a.to)):a.type==n.PUB_ACCOUNT?f.buildPubAccountJID(f.getNode(a.to)):f.buildUserJID(f.getNode(a.to),h.getInstance().getUserResource());
a.handle="mute"===a.handle?a.handle:"stick";jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/profile/"+a.handle+"?token="+h.getInstance().getToken()+"&bareJID="+c,type:"DELETE",dataType:"json",success:function(c){a.success&&a.success({id:a.to,type:a.type})},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(e){a.error&&a.error()}},complete:a.complete})},createProfile:function(a){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+
l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/profile?token="+h.getInstance().getToken(),type:"post",data:JSON.stringify(a.profile),dataType:"json",cache:!1,processData:!1,contentType:"application/json",success:function(c){a.success&&a.success(a.profile)},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(e){a.error&&a.error()}},complete:a.complete})},removeProfile:function(a){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+
"/"+l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/profile?token="+h.getInstance().getToken(),type:"PUT",data:JSON.stringify(a.profiles),dataType:"json",cache:!1,processData:!1,contentType:"application/json",success:function(c){a.success&&a.success(a.profiles)},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(e){a.error&&a.error()}},complete:a.complete})},clearProfile:function(a){jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+
l.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/profile?token="+h.getInstance().getToken(),type:"DELETE",dataType:"json",cache:!1,success:function(c){a.success&&a.success()},error:function(c){try{var d=JSON.parse(c.responseText);d&&a.error&&a.error(d)}catch(e){a.error&&a.error()}},complete:a.complete})}}}(),P=function(){return{monitor:function(){d.getInstance().registerHandler(OPCODE.UPDATE_WHITEBOARD.KEY,function(a){a.from=f.getID(a.from);h.getInstance().onWhiteBoardUpdated(a)})},operateWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,
wid:a.wid,name:a.name,origin:f.buildUserJID(f.getNode(a.origin)),operation:a.operation},OPCODE.OPERATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},listenWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,wid:a.wid,operation:a.operation},OPCODE.LISTEN_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},
a)},updateWhiteBoard:function(a){var c={id:a.id,from:a.from,wid:a.wid,nodeId:a.nodeId,nodeContent:a.nodeContent,nodeText:a.nodeText,operation:a.operation};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));c.success&&c.success(a)},a)}}}();a.prototype.startPing=function(){d.getInstance().connected()&&(this.pingInterval=setInterval(this.ping.bind(this),l.PING.INTERVAL))};a.prototype.stopPing=function(){clearTimeout(this.pingTimeout);
clearInterval(this.pingInterval)};a.prototype.ping=function(){if(!((new Date).getTime()-this.lastPongTime<l.PING.DURATION)){var a=new JumpPacket(null,OPCODE.PING.SEND);try{d.getInstance().send(a),this.pingTimeout=setTimeout(this.timeoutHandler.bind(this),l.PING.TIMEOUT)}catch(c){H.log("SNSConnectService.ping",0,c),this.stopPing(),h.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})}}};a.prototype.pong=function(){this.lastPongTime=(new Date).getTime();clearTimeout(this.pingTimeout)};
a.prototype.timeoutHandler=function(){this.stopPing();h.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype._init=function(){H.log("YYIMConnectEventHandler.prototype.registerHandler",3);if(!this._inited){var a=d.getInstance();a.registerHandler("onConnect",this.onConnected);a.registerHandler("onDisconnect",this.onDisConnect);a.registerHandler("onStatusChanged",this.connectStatusChangeHandler);a.registerHandler(OPCODE.STREAM_ERROR.KEY,this.onStreamError);a.registerHandler(OPCODE.PACKET_ERROR.KEY,
this.onPacketError);this._inited=!0}};c.prototype.onConnected=function(){l.TIMECORRECTION.AUTOCORRECTION&&h.getInstance().getTimeCorrection(function(a){l.TIMECORRECTION.RESULT=a});h.getInstance().onOpened();d.getInstance().getDaemon().startPing()};c.prototype.onConnectError=function(a){H.log("YYIMConnectEventHandler.prototype.onConnectError ",0,a);errorCode=a.getAttribute("code");d.getInstance().getDaemon().stopPing();if(401==errorCode||401==errorCode/10)h.getInstance().onAuthError({errorCode:401,
message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else h.getInstance().onConnectError({errorCode:errorCode,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype.onStreamError=function(a){H.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a);d.getInstance().getDaemon().stopPing();if(401==a.code||401==a.code/10)h.getInstance().onAuthError({errorCode:401,message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else h.getInstance().onConnectError({errorCode:a.code,message:a.message})};
c.prototype.onPacketError=function(a){H.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a)};c.prototype.onDisConnect=function(){h.getInstance().onClosed();d.getInstance().getDaemon().stopPing()};c.prototype.connectStatusChangeHandler=function(a){H.log("connectStatusChangeHandler",3,a);h.getInstance().onStatusChanged(a)};d.getInstance=function(){d._instance||(d._instance=new d,d._instance._init());return d._instance};d.prototype.getDaemon=function(){return this.daemon};d.prototype._init=function(){G.monitor();
I.monitor();r.monitor();P.monitor();h.getInstance().executeMonitor();this.eventHandler._init();this.registerHandler(OPCODE.AUTH.KEY,function(a){var c=new JSJaCJID(a.jid);a=f.getID(a.jid);h.getInstance()._user={jid:c,name:a};h.getInstance().onUserBind(a,c.getResource())});this.registerHandler(OPCODE.PING.KEY,this.getDaemon().pong.bind(this.getDaemon()))};d.prototype.registerHandler=function(a,c,d,e){if(this.connection)this.connection.registerHandler.apply(this.connection,arguments);else throw"connection is undefined!";
};d.prototype.connected=function(){return this.connection&&this.connection.connected()?!0:!1};d.prototype.getConnection=function(){this.connection||(l.useWebSocket()?this.connection=new JSJaCWebSocketConnection({httpbase:l.getWebSocketUrl()}):this.connection=new JSJaCHttpBindingConnection({httpbase:l.getHttpBindUrl(),timerval:l.CONNECTION.TIMERVAL,wait:l.CONNECTION.WAIT}));return this.connection};d.prototype.connect=function(a,c,d){this.connectArg||(this.connectArg=l.getConnectionArgObj());a&&(this.connectArg.username=
a,this.connectArg.password=c);h.getInstance()._user={jid:new JSJaCJID(this.connectArg.username+"@"+g+"/"+this.connectArg.resource),name:this.connectArg.username};this.connection.connect(this.connectArg)};d.prototype.disconnect=function(){this.daemon.stopPing();this.connection&&this.connection.disconnect()};d.prototype.send=function(a,c,d,e){this.waitingList.push({packet:a,callback:c,data:d,callbackContext:e});this.sending||this.sendInterval()};d.prototype.sendInterval=function(){var a=this;if(this.waitingList.length){this.sending=
!0;var c=this.waitingList[0],d=(new Date).getTime()-this.lastSendTime;d>=l.SENDINTERVAL?(this.sendJumpPacket(c),this.waitingList.shift(),this.lastSendTime=(new Date).getTime(),this.sendInterval()):setTimeout(function(){a.sendJumpPacket(c);a.waitingList.shift();a.lastSendTime=(new Date).getTime();a.sendInterval()},l.SENDINTERVAL-d)}else this.sending=!1};d.prototype.sendJumpPacket=function(a){return a.callbackContext?this.connection.sendJumpPacket(a.packet,a.callback.bind(a.callbackContext),a.data):
...
this,c=this.xhr;this.timeoutIndex=setTimeout(function(){a.loop&&e.prototype.get.call(a);a.eCallback(c.responseText)},a.timeout);c.onreadystatechange=function(){4==c.readyState&&(clearTimeout(a.timeoutIndex),200==c.status?a.sCallback(c.responseText):a.eCallback(c.responseText))}};var Q=function(){function a(c){var d,m=0;jQuery.ajax({url:l.SERVLET.REST_SYSTEM_SERVLET_SAFE+"time",type:"get",cache:!1,beforeSend:function(){d=(new Date).getTime()},success:function(a){m=(new Date).getTime();c&&c.success&&
c.success(a-(d+m)/2,m-d)},error:function(a){c&&c.error&&c.error()}})}return{multiPartyCall:function(a){if(!0===a.accountMmanaged){var c={etpId:l.MULTI_TENANCY.ETP_KEY,appId:l.MULTI_TENANCY.APP_KEY,caller:a.caller,phones:a.phones,username:h.getInstance().getUserNode()};jQuery.ajax({url:l.SERVLET.REST_USER_SERVLET_SAFE+"voip/make?token="+h.getInstance().getToken(),type:"post",data:JSON.stringify(c),dataType:"json",cache:!1,processData:!1,contentType:"application/json",headers:{},success:function(c){a.success&&
a.success(c)},error:function(c){a.error&&a.error()}})}else c=(new Date).getTime(),c={caller:a.caller,phones:a.phones,account_identify:a.account,userId:h.getInstance().getUserBareJID(),timestamp:c,sign:hex_sha1(a.account+a.key+c)},jQuery.ajax({url:l.MULTIPARTYCALL.ADDRESS,type:"get",data:c,dataType:"jsonp",cache:!1,jsonp:"callback",success:function(c){a.success&&a.success(c)},error:function(c){a.error&&a.error()}})},getTimeCorrection:function(c){for(var d=[],e=!1,f=0;f<l.TIMECORRECTION.TIMES;f++)a({success:function(a,
m){d.push(a);if(m<l.TIMECORRECTION.RESIDUAL)e||(e=!0,YYIMCommonUtil.isFunction(c)&&c(Math.round(a)));else if(d.length===l.TIMECORRECTION.TIMES){var f=0,g;for(g in d)f+=d[g];e=!0;YYIMCommonUtil.isFunction(c)&&c(Math.round(f/l.TIMECORRECTION.TIMES))}}})}}}(),w=function(){this._provider};w.getInstance=function(){w._instance||(w._instance=new w);return w._instance};w.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new M};w.prototype.getProvider=function(){this._provider||(this._provider=
new M);return this._provider};w.prototype.getChatGroups=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getChatGroups)&&this.getProvider().getChatGroups(a)};w.prototype.addChatGroup=function(a){G.joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.node)),success:function(){r.configChatGroup({jid:this.jid,name:a.name,desc:a.desc,error:a.error,success:function(){a.success&&a.success({name:a.name,node:a.node,id:a.id,nickname:h.getInstance().getUserID()})},complete:a.complete})},
error:function(){a.error&&a.error()}});this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addChatGroup)&&this.getProvider().addChatGroup(a)};w.prototype.createChatGroup=function(a){r.createChatGroup({id:Math.uuid(),to:a.to,name:a.name,members:a.members,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.transferChatGroup=function(a){r.transferChatGroup({id:Math.uuid(),to:a.to,newOwner:a.newOwner,success:function(c){a.success&&a.success(c)},
complete:function(){a.complete&&a.complete()}})};w.prototype.dismissChatGroup=function(a){r.dismissChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.inviteGroupMember=function(a){r.inviteGroupMember({id:Math.uuid(),to:a.to,members:a.members,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.modifyChatGroupInfo=function(a){r.modifyChatGroupInfo({id:Math.uuid(),
to:a.to,name:a.name,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.kickGroupMember=function(a){r.kickGroupMember({id:Math.uuid(),to:a.to,member:a.member,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.exitChatGroup=function(a){r.exitChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.collectChatGroup=
function(a){r.collectChatGroup({id:Math.uuid(),to:a.to,type:a.type,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};w.prototype.delGroupMember=function(a,c,d){G.delGroupMember(a,c,d)};w.prototype.quitChatGroup=function(a){G.quitChatGroup(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().quitChatGroup)&&this.getProvider().quitChatGroup(a)};w.prototype.queryChatGroup=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryChatGroup)&&
this.getProvider().queryChatGroup(a)};w.prototype.joinChatGroup=function(a){G.joinChatGroup(a)};w.prototype.updateChatGroup=function(a){r.configChatGroup(a)};var M=function(){};M.prototype.getChatGroups=function(a){r.getChatGroups(a)};M.prototype.addChatGroup=function(a){};M.prototype.quitChatGroup=function(a){};M.prototype.queryChatGroup=function(a){r.queryChatGroup(a)};var E=function(){this._provider};E.getInstance=function(){E._instance||(E._instance=new E);return E._instance};E.prototype.init=
function(a){this._provider=a&&a.provider?a.provider:new O};E.prototype.getProvider=function(){this._provider||(this._provider=new O);return this._provider};E.prototype.getGroupMembers=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getGroupMembers)&&this.getProvider().getGroupMembers(a)};E.prototype.addGroupMember=function(a,c){I.addGroupMember(a,c);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addGroupMember)&&this.getProvider().addGroupMember(a,c)};
var O=function(){};O.prototype.getGroupMembers=function(a){r.getGroupMembers(a)};O.prototype.addGroupMember=function(a,c){};var B=function(){this._provider;this._onlineList=new SNSBaseList};B.getInstance=function(){B._instance||(B._instance=new B);return B._instance};B.prototype.addToOnline=function(a){this._onlineList.add(a,!0)};B.prototype.removeFromOnline=function(a){this._onlineList.remove(a)};B.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new L};B.prototype.getProvider=
function(){this._provider||(this._provider=new L);return this._provider};B.prototype.getRosterItems=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRosterItems)&&this.getProvider().getRosterItems(a)};B.prototype.addRosterItem=function(a){G.addRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addRosterItem)&&this.getProvider().addRosterItem(a)};B.prototype.deleteRosterItem=function(a){r.deleteRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().deleteRosterItem)&&
this.getProvider().deleteRosterItem(a)};B.prototype.queryRosterItem=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryRosterItem)&&this.getProvider().queryRosterItem(a)};B.prototype.getRostersPresence=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRostersPresence)&&this.getProvider().getRostersPresence(a)};var L=function(){};L.prototype.getRosterItems=function(a){r.getRosterItems(a)};L.prototype.addRosterItem=function(a){};L.prototype.deleteRosterItem=
function(a){};L.prototype.queryRosterItem=function(a){r.queryRosterItem(a)};L.prototype.getRostersPresence=function(a){r.getRostersPresence(a)};var u=function(){},H=new function(a){this.level=a?a:0==a?0:3;this.start=function(){};this.log=function(a,c,d,m){if(l.LOG.ENABLE&&(c=c?c:0==c?0:3,!(c>this.level)&&"undefined"!=typeof console&&"undefined"!=typeof console.group))try{console.group(a);switch(c){case 0:console.error(a);console.trace();break;case 1:console.warn(a);console.trace();break;case 2:console.info(a);
break;case 4:console.debug(a);break;default:console.log(a)}var e=arguments.length;if(2<e)for(var f=2;f<e;f++){var g=arguments[f];g&&(g instanceof JSJaCPacket?console.info(g.doc.xml):console.debug(g))}console.groupEnd()}catch(h){try{console.error(h)}catch(k){}}};this.logParam=function(a){this.log("arguments:",a||3,this.logParam.caller.arguments)};this.setLevel=function(a){this.level=a;return this};this.getLevel=function(){return this.level}}(l.LOG.FILTER_LEVEL),h=function(){this._user;this.init();
this._token={};this._anonymousUser=!1;this.appkey;this.version="2.0"};h.getInstance=function(){h._instance||(h._instance=new h);return h._instance};h.prototype.log=function(a,c,d,e){H.log(a,c,d,e)};h.prototype.init=function(a){a=a||{};this.onOpened=a.onOpened||u;this.onClosed=a.onClosed||u;this.onAuthError=a.onAuthError||u;this.onStatusChanged=a.onStatusChanged||u;this.onConnectError=a.onConnectError||u;this.onUserBind=a.onUserBind||u;this.onPresence=a.onPresence||u;this.onSubscribe=a.onSubscribe||
u;this.onRosterDeleted=a.onRosterDeleted||u;this.onRosterUpdateded=a.onRosterUpdateded||u;this.onGroupUpdate=a.onGroupUpdate||u;this.onTransferGroupOwner=a.onTransferGroupOwner||u;this.onKickedOutGroup=a.onKickedOutGroup||u;this.onRoomMemerPresence=a.onRoomMemerPresence||u;this.onPubaccountUpdate=a.onPubaccountUpdate||u;this.onMessage=a.onMessage||u;this.onReceipts=a.onReceipts||u;this.onTextMessage=a.onTextMessage||u;this.onPictureMessage=a.onPictureMessage||u;this.onFileMessage=a.onFileMessage||
u;this.onShareMessage=a.onShareMessage||u;this.onSystemMessage=a.onSystemMessage||u;this.onPublicMessage=a.onPublicMessage||u;this.onDeviceMessage=a.onDeviceMessage||u;this.onAudoMessage=a.onAudoMessage||u;this.onLocationMessage=a.onLocationMessage||u;this.onWhiteBoardMessage=a.onWhiteBoardMessage||u;this.onTransparentMessage=a.onTransparentMessage||u;this.onNetMeetingMessage=a.onNetMeetingMessage||u;this.onWhiteBoardUpdated=a.onWhiteBoardUpdated||u;this.onNetMeetingJoined=a.onNetMeetingJoined||u;
this.onNetMeetingInvited=a.onNetMeetingInvited||u;this.onNetMeetingEnded=a.onNetMeetingEnded||u;this.onNetMeetingExited=a.onNetMeetingExited||u;this.onNetMeetingOpenVideo=a.onNetMeetingOpenVideo||u;this.onNetMeetingCloseVideo=a.onNetMeetingCloseVideo||u;this.onNetMeetingOpenMicrophone=a.onNetMeetingOpenMicrophone||u;this.onNetMeetingCloseMicrophone=a.onNetMeetingCloseMicrophone||u;this.onNetMeetingTimeout=a.onNetMeetingTimeout||u;this.onNetMeetingAgreed=a.onNetMeetingAgreed||u;this.onNetMeetingRefuse=
a.onNetMeetingRefuse||u;this.onNetMeetingMuted=a.onNetMeetingMuted||u;this.onNetMeetingMutedAll=a.onNetMeetingMutedAll||u;this.onNetMeetingKicked=a.onNetMeetingKicked||u;this.onNetMeetingRoleConversion=a.onNetMeetingRoleConversion||u;this.onNetMeetingLocked=a.onNetMeetingLocked||u;(function(){l.useWebSocket()||(window.onbeforeunload=function(){h.getInstance().disConnect()})})()};h.prototype.initUpload=function(){if(arguments&&SNSIMUploadUseFlash&&"function"==typeof SNSIMUploadUseFlash.prototype.addUploader)for(var a=
0;a<arguments.length;a++){var c=arguments[a];"string"==typeof c.button_placeholder_id&&SNSIMUploadUseFlash.getInstance().addUploader(c)}};h.prototype.initSDK=function(a,c,d){var e=l.MULTI_TENANCY;e.ENABLE=!0;e.APP_KEY=a;e.ETP_KEY=c;this.appkey=e.SEPARATOR+e.APP_KEY+e.SEPARATOR+e.ETP_KEY;d&&(k=d.address||k,l.CONNECTION.HTTP_BASE=k,q=d.wsport||q,l.CONNECTION.WS_PORT=q,t=d.hbport||t,l.CONNECTION.HTTP_BIND_PORT=t,v=d.servlet||v,s=d.safeServlet||s,l.SERVLET={FILE_UPLOAD_SERVLET:v+"sysadmin/fileUpload",
FILE_DOWNLOAD_SERVLET:v+"sysadmin/download",FILE_DELETE_SERVLET:v+"sysadmin/cancel",AVATAR_SERVLET:v+"sysadmin/avatar",REST_RESOURCE_SERVLET:v+"sysadmin/rest/resource/",REST_HISTORY_SERVLET:v+"sysadmin/rest/history/",REST_VERSION_SERVLET:v+"sysadmin/rest/version/",REST_USER_SERVLET:v+"sysadmin/rest/user/",REST_UPLOAD_SERVLET:v+"im_upload/rest/resource/",REST_DOWNLOAD_SERVLET:v+"im_download/rest/resource/",REST_TRANSFORM_SERVLET:v+"im_download/rest/transform/resource/",REST_USER_SERVLET_SAFE:s+"sysadmin/rest/user/",
REST_SYSTEM_SERVLET_SAFE:s+"sysadmin/rest/system/"})};h.prototype.getTenancy=function(){return l.MULTI_TENANCY};h.prototype.getAppkey=function(){return this.appkey};h.prototype.setRosterProvider=function(a){B.getInstance().init({provider:a||new L})};h.prototype.setChatGroupProvider=function(a){w.getInstance().init({provider:a||new M})};h.prototype.setChatGroupMemberProvider=function(a){E.getInstance().init({provider:a||new O})};h.prototype.setServer=function(a,c){l.CONNECTION.SERVER_NAME=a;l.CONNECTION.HTTP_BASE=
c?c:a};h.prototype.disConnect=function(){d.getInstance().disconnect()};h.prototype.connect=function(){d.getInstance().connect()};h.prototype.getToken=function(){return this._token.token};h.prototype.getTokenExpiration=function(){return this._token.expiration};h.prototype.login=function(a,c,e){this._token={token:c,expiration:e};!YYIMCommonUtil.isStringAndNotEmpty(a)&&l.IS_ANONYMOUS&&(this._anonymousUser=!0);!this.isAnonymous()&&l.MULTI_TENANCY.ENABLE&&(a=f.getNode(a));d.getInstance().connect(a,c)};
h.prototype.logout=function(){d.getInstance().disconnect()};h.prototype.getUserBareJID=function(){return this._user.jid.getBareJID()};h.prototype.getUserFullJID=function(){return this._user.jid.toString()};h.prototype.getUserNode=function(){return f.getNode(this.getUserBareJID())};h.prototype.getUserID=function(){return f.getID(this.getUserBareJID())};h.prototype.getUserResource=function(){return l.RESOURCE};h.prototype.getProfile=function(a){J.getProfile(a||{})};h.prototype.mute=function(a){a=a||
{};a.to?(a.handle="mute",J.muteStick(a)):a.error&&a.error()};h.prototype.stick=function(a){a=a||{};a.to?(a.handle="stick",J.muteStick(a)):a.error&&a.error()};h.prototype.cancelMute=function(a){a=a||{};a.to?(a.handle="mute",J.cancelMuteStick(a)):a.error&&a.error()};h.prototype.cancelStick=function(a){a=a||{};a.to?(a.handle="stick",J.cancelMuteStick(a)):a.error&&a.error()};h.prototype.createProfile=function(a){a=a||{};a.profile?J.createProfile(a):a.error&&a.error()};h.prototype.removeProfile=function(a){a=
a||{};YYIMArrayUtil.isArray(a.profiles)?J.removeProfile(a):a.error&&a.error()};h.prototype.clearProfile=function(a){J.clearProfile(a||{})};h.prototype.fullSyncRoster=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({jid:f.buildUserJID(f.getNode(a[c].id)),name:a[c].name?a[c].name:a[c].id});r.fullSyncRoster(d)}};h.prototype.deltaSyncRoster=function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&
g.push(f.buildUserJID(f.getNode(a[d])));if(YYIMArrayUtil.isArray(c))for(e=c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({jid:f.buildUserJID(f.getNode(c[e].id)),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||r.deltaSyncRoster(g,h)};h.prototype.fullSyncChatGroup=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({id:f.getID(a[c].id),name:a[c].name?a[c].name:a[c].id});r.fullSyncChatGroup(d)}};h.prototype.deltaSyncChatGroup=
function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.getID(a[d]));if(YYIMArrayUtil.isArray(c))for(e=c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({id:f.getID(c[e].id),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||r.deltaSyncChatGroup(g,h)};h.prototype.setPresence=function(a){var c={};if(a){if(a.show)for(var d in A)if(A[d]===a.show){c.show=A[d];break}if(!c.show&&a.status)for(d in A)if(A[d]===
a.status){c.show=A[d];break}c.status=a.status}c.show=c.show?c.show:A.AVAILABLE;G.setPresence(c)};h.prototype.getVCard=function(a){var c={success:a.success,error:a.error,complete:a.complete};YYIMCommonUtil.isStringAndNotEmpty(a.id)&&(c.jid=f.buildUserJID(f.getNode(a.id)));r.getVCard(c)};h.prototype.getVCards=function(a){r.getVCards({success:a.success,error:a.error,complete:a.complete})};h.prototype.setVCard=function(a){r.setVCard({vcard:{nickname:a.vcard.nickname,photo:a.vcard.photo,email:a.vcard.email,
mobile:a.vcard.mobile,telephone:a.vcard.telephone,organization:a.vcard.organization,gender:a.vcard.gender,number:a.vcard.number,remarks:a.vcard.remarks,location:a.vcard.location,position:a.vcard.position},success:a.success,error:a.error})};h.prototype.setVCardTag=function(a){a=a||{};if(YYIMArrayUtil.isArray(a.tag)){var c=this;r.setTag({tag:a.tag,success:function(d){c.getVCard({id:d,success:function(c){a.success&&a.success(c)}})},error:a.error})}else a.error&&a.error()};h.prototype.removeVCardTag=
function(a){a=a||{};if(YYIMArrayUtil.isArray(a.tag)){var c=this;r.removeTag({tag:a.tag,success:function(d){c.getVCard({id:d,success:function(c){a.success&&a.success(c)}})},error:a.error})}else a.error&&a.error()};h.prototype.setRosterTag=function(a){a=a||{};a.id&&YYIMArrayUtil.isArray(a.tag)&&a.id!=this.getUserID()?r.setTag({id:a.id,tag:a.tag,success:function(c){a.success&&a.success(c)},error:a.error}):a.error&&a.error()};h.prototype.removeRosterTag=function(a){a=a||{};a.id&&YYIMArrayUtil.isArray(a.tag)&&
a.id!=this.getUserID()?r.removeTag({id:a.id,tag:a.tag,success:function(c){a.success&&a.success(c)},error:a.error}):a.error&&a.error()};h.prototype.getRosterItems=function(a){B.getInstance().getRosterItems(a)};h.prototype.addRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&B.getInstance().addRosterItem(f.buildUserJID(f.getNode(a)))};h.prototype.approveSubscribe=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&G.approveSubscribe(f.buildUserJID(f.getNode(a)))};h.prototype.rejectSubscribe=
function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&G.rejectSubscribe(f.buildUserJID(f.getNode(a)))};h.prototype.deleteRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&B.getInstance().deleteRosterItem({jid:f.buildUserJID(f.getNode(a.id)),success:a.success,error:a.error,complete:a.complete})};h.prototype.queryRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&B.getInstance().queryRosterItem(a)};h.prototype.getRostersPresence=function(a){YYIMArrayUtil.isArray(a.username)&&
(a.username=JSON.stringify(a.username),B.getInstance().getRostersPresence(a))};h.prototype.getRecentContacts=function(a){r.getRecentContacts(a)};h.prototype.getRecentDigset=function(a){r.getRecentDigset(a)};h.prototype.updateRosterItem=function(a){a&&a.roster&&YYIMCommonUtil.isStringAndNotEmpty(a.roster.id)&&r.updateRosterItem({roster:{jid:f.buildUserJID(f.getNode(a.roster.id)),name:a.roster.name,groups:a.roster.groups},success:a.success,error:a.error})};h.prototype.queryChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&
w.getInstance().queryChatGroup(a)};h.prototype.quitChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&w.getInstance().quitChatGroup(f.buildChatGroupJID(f.getNode(a)))};h.prototype.delGroupMember=function(a,c,d){YYIMCommonUtil.isStringAndNotEmpty(c)&&w.getInstance().delGroupMember(f.buildChatGroupJID(f.getNode(a)),f.buildUserJID(f.getNode(c)),d)};h.prototype.joinChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&w.getInstance().joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),
success:a.success,error:a.error})};h.prototype.getChatGroupInfo=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&r.getChatGroupInfo({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};h.prototype.getPubAccount=function(a){r.getPubAccountItems(a)};h.prototype.addPubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?G.addPubAccount({jid:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};h.prototype.removePubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?
G.removePubAccount({id:Math.uuid(),to:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};h.prototype.queryPubaccount=function(a){r.queryPubaccount(a)};h.prototype.getChatGroups=function(a){w.getInstance().getChatGroups(a)};h.prototype.addGroupMember=function(a){if(YYIMCommonUtil.isStringAndNotEmpty(a.roomId)&&YYIMArrayUtil.isArray(a.ids)){var c=f.buildChatGroupJID(f.getNode(a.roomId));a=a.ids.slice();for(var d=0,e=a.length;d<e;d++)a[d]=f.buildUserJID(f.getNode(a[d]));
E.getInstance().addGroupMember(c,a)}};h.prototype.addChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.node)&&w.getInstance().addChatGroup(a)};h.prototype.createChatGroup=function(a){YYIMArrayUtil.isArray(a.members)||delete a.members;a.name?w.getInstance().createChatGroup(a):a.error&&a.error()};h.prototype.transferChatGroup=function(a){a&&"string"==typeof a.newOwner&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().transferChatGroup(a)):a.error&&a.error()};h.prototype.dismissChatGroup=
function(a){a&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().dismissChatGroup(a)):a.error&&a.error()};h.prototype.getSharedFiles=function(a){a&&a.id&&r.getSharedFiles(a)};h.prototype.inviteGroupMember=function(a){a.members&&YYIMArrayUtil.isArray(a.members)&&a.members.length&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().inviteGroupMember(a)):a.error&&a.error()};h.prototype.modifyChatGroupInfo=function(a){a.name&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().modifyChatGroupInfo(a)):
a.error&&a.error()};h.prototype.kickGroupMember=function(a){a.member&&"string"==typeof a.member&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().kickGroupMember(a)):a.error&&a.error()};h.prototype.exitChatGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),w.getInstance().exitChatGroup(a)):a.error&&a.error()};h.prototype.collectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="add",w.getInstance().collectChatGroup(a)):a.error&&a.error()};h.prototype.removeCollectGroup=
function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="remove",w.getInstance().collectChatGroup(a)):a.error&&a.error()};h.prototype.updateChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&w.getInstance().updateChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),name:a.name,desc:a.desc,photo:a.photo,error:a.error,success:a.success,complete:a.complete})};h.prototype.getGroupMembers=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&E.getInstance().getGroupMembers({jid:f.buildChatGroupJID(f.getNode(a.id)),
success:a.success,error:a.error,complete:a.complete})};h.prototype.getHistoryMessage=function(a){if(!a.start||isNaN(a.start))a.start=0;if(!a.num||isNaN(a.num))a.num=100;I.getHistoryMessage(a)};h.prototype.getOfflineMessage=function(a){a=a||{};I.getOfflineMessage({id:this.getUserID(),success:a.success,error:a.error,complete:a.complete})};h.prototype.sendReceiptsPacket=function(a){I.sendReceiptsPacket(a)};h.prototype.sendReadedReceiptsPacket=function(a){I.sendReadedReceiptsPacket(a)};h.prototype.sendMessage=
function(a){I.sendMessage(a)};h.prototype.sendAccessoryMessage=function(a){a.id=Math.uuid();var c=new SNSFile(a.body.content.name,a.body.content.attachId,a.body.content.size);a.body={content:c,contentType:a.contentType||x.FILE,dateline:(new Date).getTime()};YYIMChat.sendMessage(a)};h.prototype.sendFormMessage=function(a){var c={token:this.getToken(),creator:this.getUserID()+"."+l.MULTI_TENANCY.APP_KEY+"."+l.MULTI_TENANCY.ETP_KEY,receiver:a.to+"."+l.MULTI_TENANCY.APP_KEY+"."+l.MULTI_TENANCY.ETP_KEY,
mediaType:a.mediaType||2,randomId:Math.uuid(),name:a.file.name,size:a.file.size},d=l.SERVLET.REST_RESOURCE_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/upload",d=d+("?"+jQuery.param(c));jQuery.ajax({xhr:function(){var c=new window.XMLHttpRequest;c.upload.addEventListener("progress",function(c){if(c.lengthComputable){var d=c.loaded/c.total;a.progress&&a.progress({loaded:c.loaded,total:c.total,percent:d})}},!1);c.addEventListener("progress",function(c){if(c.lengthComputable){var d=
c.loaded/c.total;a.progress&&a.progress({loaded:c.loaded,total:c.total,percent:d})}},!1);return c},url:d,type:"post",dataType:"json",data:a.data,processData:!1,contentType:!1,success:function(d){d&&d.attachId?(d={to:a.to,body:{content:{name:a.file.name,size:a.file.size,attachId:d.attachId}},type:a.type,success:a.success},d.contentType=1===c.mediaType?x.IMAGE:x.FILE,h.getInstance().sendAccessoryMessage(d)):a.error&&a.error()},error:function(c,d){a.error&&a.error()},complete:function(c,d){a.complete&&
a.complete()}})};h.prototype.sendShareMessage=function(a){a.content=a.sharebody||a.content;a.contentType=x.SHARE;this.postMessage(a)};h.prototype.sendWhiteBoardMessage=function(a){a.contentType=x.WHITEBOARD;this.postMessage(a)};h.prototype.sendTextMessage=function(a){a.content=a.msg||a.content;a.contentType=x.TEXT;this.postMessage(a)};h.prototype.postMessage=function(a){a.id=Math.uuid();a.type=a.type||n.CHAT;a.body={extend:a.extend,content:a.content,contentType:a.contentType,dateline:(new Date).getTime()};
a.type===n.GROUP_CHAT&&YYIMArrayUtil.isArray(a.atuser)&&(a.body.atuser=a.atuser);a.style&&"string"!=typeof a.style&&(a.body.style=JSON.stringify(a.style));this.sendMessage(a)};h.prototype.revocationMessage=function(a){a&&a.id?I.revocationMessage(a):a&&a.error&&a.error()};h.prototype.sendPic=function(a){var c=f.getNode(a.to),c=a.type==n.GROUP_CHAT?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"jpg;jpeg;png;bmp;gif",fileSizeLimit:102400,breakPoints:!1,saveInfoLocal:!1,removeTimeout:100,uploader:l.SERVLET.FILE_UPLOAD_SERVLET,
uploadIdPrefix:"image_upload_",inputId:a.fileInputId,to:c,type:x.IMAGE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};h.prototype.sendFile=function(a){var c=f.getNode(a.to),c=a.type==n.GROUP_CHAT?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"*",
fileSizeLimit:99999999,breakPoints:!0,saveInfoLocal:!0,removeTimeout:100,uploader:l.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"bp_upload_",inputId:a.fileInputId,to:c,type:x.FILE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!0,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};h.prototype.uploadAvatar=
function(a){var c=f.getNode(a.to),c=a.type==n.GROUP_CHAT?f.buildChatGroupJID(c):f.buildUserJID(c);FileUpload.getInstance(a.fileInputId,{fileTypeExts:"jpg;jpeg;png;bmp;gif",fileSizeLimit:5120,breakPoints:!1,saveInfoLocal:!1,removeTimeout:100,uploader:l.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"user_avatar_upload_",inputId:a.fileInputId,to:c,type:UPLOAD_AVATAR,onUploadSuccess:a.success,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"});FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};
h.prototype.getServerName=function(){return l.CONNECTION.SERVER_NAME};h.prototype.getTransformFileList=function(a){jQuery.ajax({url:l.SERVLET.REST_TRANSFORM_SERVLET+"docInfo",type:"get",data:{attachId:a.attachId,token:this.getToken(),downloader:this.getUserNode()},dataType:"json",cache:!1,success:function(c){a.success&&a.success(c)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})};h.prototype.getFileUrl=function(a,c){if(a)return-1<a.indexOf(l.SERVLET.REST_RESOURCE_SERVLET)?
a:l.SERVLET.REST_RESOURCE_SERVLET+l.MULTI_TENANCY.ETP_KEY+"/"+l.MULTI_TENANCY.APP_KEY+"/download?"+jQuery.param({attachId:a,downloader:this.getUserNode(),token:this.getToken(),mediaType:1===c?c:2})};h.prototype.getServletPath=function(){return l.SERVLET};h.prototype.getJIDUtil=function(){return f};h.prototype.getArrayUtil=function(){return YYIMArrayUtil};h.prototype.isAnonymous=function(){return this._anonymousUser};h.prototype.enableAnonymous=function(){return l.IS_ANONYMOUS};h.prototype.getBrowser=
function(){return l.BROWSER};h.prototype.isOnline=function(a){return!0==B.getInstance()._onlineList.get(a)};h.prototype.multiPartyCall=function(a){if("undefined"!==typeof a&&"undefined"!==typeof a.caller&&YYIMArrayUtil.isArray(a.phones)&&a.phones.length)if(YYIMRegularUtil.phone.test(a.caller)){var c=[],d;for(d in a.phones){var e=a.phones[d].toString();if(YYIMRegularUtil.phone.test(e)&&-1===c.indexOf(e)&&(c.push(e),e=c.join(","),c.length>l.MULTIPARTYCALL.PARTYMAXLENGTH||e.length>l.MULTIPARTYCALL.PHONESMAXLENGTH)){c.pop();
break}}if(c.length){a.caller=a.caller.toString();a.phones=c;if(!0!==a.accountMmanaged&&(a.phones=c.join(","),a.account=a.account?a.account:l.MULTIPARTYCALL.ACCOUNT,a.key=a.key?a.key:l.MULTIPARTYCALL.KEY,"undefined"===typeof a.account||"undefined"===typeof a.key)){a.error&&a.error();return}Q.multiPartyCall(a)}else a.error&&a.error()}else a.error&&a.error();else a.error&&a.error()};h.prototype.getTimeCorrection=function(a){Q.getTimeCorrection(a)};h.prototype.operateWhiteBoard=function(a){var c={id:Math.uuid(),
origin:a.origin,operation:a.operation||"create",success:a.success,error:a.error,complete:a.complete};"create"!==a.operation&&(c.wid=a.wid);if("create"===a.operation||"rename"===a.operation)c.name=a.name;c.wid&&c.origin&&"listen"===c.operation?P.listenWhiteBoard(c):!c.origin||"create"!==c.operation&&"end"!==c.operation&&"rename"!==c.operation?a.error&&a.error():P.operateWhiteBoard(c)};h.prototype.updateWhiteBoard=function(a){a.wid&&a.nodeId?(a.id=Math.uuid(),a.from=h.getInstance().getUserFullJID(),
a.operation="delete"===a.operation?"delete":"update","update"!=a.operation||a.nodeContent?P.updateWhiteBoard(a):a.error&&a.error()):a.error&&a.error()};h.prototype.getConfig=function(){return l};h.prototype.getConnection=function(){return d.getInstance()};h.prototype.getJIDUtil=function(){return f};h.prototype.setMonitor=function(a,c){a&&YYIMCommonUtil.isFunction(c)&&(this.monitors=this.monitors||{},this.monitors[a]=c)};h.prototype.executeMonitor=function(){for(var a in this.monitors){var c=this.monitors[a];
if(YYIMCommonUtil.isFunction(c))try{c()}catch(d){h.getInstance().log(a,0)}}};return h.getInstance()}();
