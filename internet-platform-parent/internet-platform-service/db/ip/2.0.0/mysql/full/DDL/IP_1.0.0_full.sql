...
CREATE TABLE `ask_for_leave` (
  ...
  `usid` varchar(50) character set utf8 default NULL,
...
CREATE TABLE `ip_company` (
  ...
  `CO_CODE_TMP` varchar(30) default NULL COMMENT '部门原始code',
  PRIMARY KEY  (`CO_ID`),
...
-- ----------------------------
-- Table structure for `ip_company_syn`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ip_hirer_syn`
-- ----------------------------
...
-- ----------------------------
-- Records of ip_hirer_syn
-- ----------------------------

-- ----------------------------
-- Table structure for `ip_index_config`
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ip_menu_icon`
-- ----------------------------
...
CREATE TABLE `ip_notice` (
  ...
  `notice_content` varchar(3000) NOT NULL COMMENT '公告标题',
...
-- ----------------------------
-- Table structure for `ip_role_syn`
-- ----------------------------
